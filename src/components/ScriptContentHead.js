...
const ScriptContentHead = props => {
  // console.log("ScriptContentHead", props)
  ...
  useEffect(() => {
    // console.log("addScript", addScript, props)
  }, [addScript])
        ...
        .forEach(oo => {
          ...
          if (props.script_content_ie_type.condition === "include_option") {
            if (tmpAddScript !== true) {
              ...
              // console.log("set for include ", currPathSliced, tmpAddScript)
            ...
            if (tmpAddScript !== false) {
              ...
              // console.log("set for ", props.banner_name, tmpAddScript)
              setAddScript(tmpAddScript)
            }
          } else {
            setAddScript(tmpAddScript)
    ...
    <Helmet>
      {props.head_scripts &&
        props.head_scripts.map(l_script => {
          ...
          // console.log("l_scripts", l_script)
          return (
