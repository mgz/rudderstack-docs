                            ...
                            <a
                              ...
                              className={
                                (btn.btnhiglight === true
                                  ? "text-darkScheme-textBlack border border-none btn-secondary-lg bg-darkScheme-btnPrimaryBg hover:bg-transparent"
                                  : "btn-secondary-lg") +
                          ...
                          return (
                            ...
                            >
                              <span
                                className={
                                  (btn.btnhiglight === true
                                    ? "text-darkScheme-textPrimary border border-none btn-secondary-lg bg-darkScheme-btnPrimaryBg hover:bg-transparent"
                                    : "btn-secondary-lg") +
