...
const MigrationSpecialists = () => {
  return (
    <div className="md:w-full px-5 md:px-0 faq-cta-box mx-auto my-20 mt-16 triggers">
      <div className="md:py-8 text-center font-bold border border-grayColor-priceCardBorder max-w-screen-lg m-auto faqcta rounded-xl shadow-xl faq-cta py-4 px-4 md:px-0">
        ...
        <Link
          ...
          to="/request-demo"
          className="inline-block text-xl-2 md:text-2xl font-bold mt-4 md:mt-5 md:px-4 mx-auto text-darkScheme-textPrimary relative"
        >
