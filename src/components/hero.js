...
function Hero(props) {
  ...
  return (
    <section class="max-w-6xl px-4 md:px-3 sm:my-20 md:mt-30 md:mb-40 mx-auto relative banner-section">
      <div class="flex flex-col items-center md:gap-12 xl:gap-24 justify-center mx-auto lg:flex-row lg:p-0">
          <div
              class="relative z-20 flex flex-col w-full pb-1 mr-30 mb-8 sm:mb-16 text-2xl lg:w-1/2 sm:px-0 sm:items-center lg:items-start lg:mb-0 hero-content">
