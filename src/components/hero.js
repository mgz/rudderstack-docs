                              ...
                              (btn, i) => (
                                ...
                                {(() => {
                                  if (btn.btnexternallink === true){
                                    ...
                                    return(
                                        <span key={btn._key} className={(btn.btnhiglight === true ? 'bg-primary text-white' : '') + ` py-2 text-sm md:px-8 lg:px-8 px-2 text-center mr-4 md:mb-0 mb-4 md:flex block rounded-lg border border-black`}>
