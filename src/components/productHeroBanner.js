...
const ProductHeroBanner = props => {
  ...
  return (
    <section className="w-full  py-10 flex justify-center items-center relative overflow-hidden gradiant-layer banner-section product-hero-banner pb-16 lg:pb-36">
