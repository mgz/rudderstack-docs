      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 flex flex-col pr-4 md:pr-20 mb-6 md:mb-0">
            <h3 className={`${props.left_content_title && props.left_content_title !== "" ? 'md:h-16' : 'h-0 md:h-16'} text-3xl font-bold `}>
          ...
          <div className="w-full md:w-1/2 flex flex-col pr-4 md:pr-20 mb-6 md:mb-0">
            <h3 className={`${props.right_content_title && props.right_content_title !== "" ? 'md:h-16' : 'h-0 md:h-16'} text-3xl font-bold `}>
