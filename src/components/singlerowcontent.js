    ...
    <div key="0"
      ...
      <div className="md:flex">
        ...
        <div class="p-8">
          ...
          <h2
            className="block mt-14 text-4xl leading-tight font-medium text-black hover:underline">
            <Link to={hit.slug}>{hit.title}</Link>
          </h2>

          <div class="mt-2 text-3xl text-indigo-700 font-bold">
