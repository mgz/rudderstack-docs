...
const HeroBannerIntegrationConnection = props => {
  console.log("hari test", props.integration_connection.image_header_source)
  return (
      ...
      <div className="flex flex-col items-center md:gap-2  justify-center mx-auto lg:flex-row lg:p-0">
        ...
        >
          <div className="relative rounded-md group sm:px-0 sm:items-center lg:items-start">
            <div className="">
              {props.integration_connection.image_header_source === "mobile" &&
                props.integration_connection.image_header_name ===
                  ...
                  <StaticImage
                    ...
                    className="object-cover w-64 lg:w-96"
                  />
                )}
              ...
              {props.integration_connection.image_header_source === "desktop" &&
                props.integration_connection.image_header_name ===
                  ...
                  <StaticImage
                    ...
                    alt="Header image"
                    placeholder="tracedSVG"
                    className="object-cover w-52 lg:w-80"
                  />
                )}
