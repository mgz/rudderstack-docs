...
const ProductImageWithListOfText = props => {
  ...
  return (
    <section className="100% section-gradient  left-right-section sm:py-24 py-11">
      <div className="max-w-6xl px-4 md:px-3 mx-auto">
        <h3 className="md:mt-2 text-white text-4xl md:text-5xl font-bold leading-tight tracking-tight-2 max-w-2xl text-center mx-auto">
