...
const Threerowcontent = ({ hits }) => {
  ...
  return (
    <div className="mt-24">
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 xl:gap-8">
        {hits.map((hit, index) => {
          if (index !== 0) {
            return (
              <section key={index} className="flex">
                <div
                  className="w-full relative overflow-hidden rounded-3xl flex shadow-md border border-grayColor-priceCardBorder bg-white">
                  <div
                    ...
                    <div className="sm:max-w-sm sm:flex-none md:w-auto md:flex-auto flex flex-col items-start relative z-10 p-6 xl:p-6">
                      ...
                      <div className="mt-4 text-sm text-blueNew-textblue font-bold">
