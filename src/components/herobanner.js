  ...
  return (
    <div className="mx-auto items-center">
      ...
      <div className="w-full h-96 justify-center items-start text-center relative object-cover" style={{ backgroundImage: `url(${image.asset.fluid.src})` }}>
        <div className="w-full h-full bg-blue-300 bg-opacity-50 table">
        <div className="w-full leading-normal text-2xl mb-8 object-center z-10 text-white table-cell align-middle">
