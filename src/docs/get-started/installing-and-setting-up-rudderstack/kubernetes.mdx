...
You can self-host your own Control Plane using the open-source [**RudderStack Config Generator**](../../user-guides/how-to-guides/rudderstack-config-generator).
...
<div class="dangerBlock">
  ...
  <a href="../../get-started/installing-and-setting-up-rudderstack/adding-a-new-user-transformation-in-rudderstack/">
    Transformations
  </a>{" "}
  and{" "}
...
<div class="infoBlock">
  Refer to the{" "}
  <a href="../../get-started/installing-and-setting-up-rudderstack/kubernetes#configuration">
    Configuration
  </a>{" "}
