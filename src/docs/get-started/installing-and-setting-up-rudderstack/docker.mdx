...
You can self-host your own Control Plane using the open-source [**RudderStack Config Generator**](../../../user-guides/how-to-guides/rudderstack-control-plane-lite.md).
