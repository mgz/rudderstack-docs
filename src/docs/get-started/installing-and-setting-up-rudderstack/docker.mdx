...
You can self-host your own Control Plane using the open-source [**Control Plane Lite**](../control-plane-lite/).

<div class="dangerBlock">

Note that the Control Plane set up using <a href="../control-plane-lite/">Control Plane Lite</a> lacks certain features like <a href="../../../transformations/">Transformations</a> and <a href="../../../user-guides/how-to-guides/live-destination-event-debugger/">Live Events</a> tab.
...
If you have self-hosted the Control Plane using the open-source [**Control Plane Lite**](../control-plane-lite/) utility, follow [**these**](https://rudderstack.com/docs/get-started/control-plane-lite/#docker) instructions to set up the RudderStack Data Plane on Docker.
