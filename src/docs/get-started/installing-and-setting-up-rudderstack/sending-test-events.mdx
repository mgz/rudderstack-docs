...
- Set up a source and a destination in RudderStack by following this [**guide**](../../../connections/adding-source-and-destination-rudderstack/).
- You can find the write key in the dashboard, as shown:

![](../../../images/assets/screen-shot-2021-07-01-at-5.27.53-pm.png)
...
<div class="warning">
The <strong>write key</strong> is different from your <strong>workspace token</strong>. The write key is associated with the source, while the workspace token is associated with your RudderStack workspace.

</div>

![](../../../images/assets/screen-shot-2021-07-01-at-5.29.03-pm.png)

#### **Option 2: If you are self-hosting RudderStack and have set up the control plane using the** [**RudderStack Config Generator**](../../config-generator/)**, you can find the source write key by following these steps:**

- Set up a source and a destination by following this [**guide**](../../../connections/adding-source-and-destination-rudderstack/).
- You can find the write key associated with the source in the dashboard as shown:

<!--![](../../../images/assets/writekey.jpg)-->
...
- You can then check your destination to verify that events are delivered. You can also view the live events via RudderStack's [**Live Events**](../../../user-guides/how-to-guides/live-destination-event-debugger/) tab.
...
<!--![](../../../images/assets/test-event%20%281%29.jpg)-->
...
<div class="infoBlock">
Note that unlike RudderStack Cloud, the Control Plane set up using the open-source <a href="../../config-generator/">Config Generator</a> does not let you view live events.

</div>

If you supply an invalid source write key or Data Plane URL, you will get the following error:

![](../../../images/assets/error.jpg)
...
- Set up a source in RudderStack by following this [**guide**](../../../connections/adding-source-and-destination-rudderstack/).
- You can find the write key in the dashboard, as shown:
...
#### **If you are self-hosting RudderStack and have set up the control plane using the** [**RudderStack Config Generator**](../../config-generator/)**, you can find the source write key by following these steps:**

- Set up a source by following this [**guide**](../../../connections/adding-source-and-destination-rudderstack/).
- You can find the write key associated with the source in the dashboard as shown:
...
<div class="infoBlock">
Follow <a href="../../installing-and-setting-up-rudderstack/#what-is-a-data-plane-url-where-do-i-get-it">this section</a> for details on how to get your Data Plane URL.

</div>
<div class="successBlock">
Refer to the <a href="../../../rudderstack-api/http-api-specification/">HTTP API
