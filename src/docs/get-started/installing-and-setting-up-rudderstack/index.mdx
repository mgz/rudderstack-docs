...
The <a href="https://rudderstack.com/docs/get-started/live-events/">Live Events</a> console can be used to temporarily stream events for debugging purposes, but only for a limited time. **RudderStack does not persist any of your data**.

</div>

If you do not wish to sign up for RudderStack and want to self-host the Control Plane, you can do so using the open-source [**RudderStack Config Generator**](https://rudderstack.com/docs/user-guides/how-to-guides/rudderstack-control-plane-lite.md).

<div class="warningBlock">

Note that the Control Plane set up using the Config Generator does not have features like <a href="https://rudderstack.com/docs/transformations"> Transformations</a> and <a href="https://rudderstack.com/docs/get-started/live-events/">Live Events</a>.
</div>
