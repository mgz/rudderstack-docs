...
<div class="successBlock">
  ...
  The easiest way to get started with RudderStack is to sign up for free on{" "}
  <a href="https://app.rudderlabs.com/signup?type=freetrial">
...
<div class="warningBlock">
  ...
  Docker images with bug fixes much more frequently than our{" "}
  <a href="https://github.com/rudderlabs/rudder-server">GitHub repository</a>.
</div>
...
<div class="successBlock">
  ...
  for help if you're stuck at any stage of the setup process.
</div>
...
<div class="infoBlock">
  ...
  Refer to the{" "}
  <a href="../rudderstack-architecture">RudderStack Architecture</a> guide for
  more information the RudderStack Data Plane.
</div>
...
For more information on the RudderStack Server running modes, refer to our <a href="../../user-guides/administrators-guide/high-availability">High Availability</a> guide.
=======
For more information on the RudderStack Server running modes, refer to our <a href="../../user-guides/administrators-guide/high-availability/">High Availability</a> guide.
...
The <a href="../live-events">Live Events</a> console can be used to temporarily stream events for debugging purposes, but only for a limited time. <strong>RudderStack does not persist any of your data</strong>.

</div>

If you do not wish to sign up for RudderStack and want to self-host the Control Plane, you can do so using the open-source [**RudderStack Config Generator**](../../user-guides/how-to-guides/rudderstack-control-plane-lite.md).

<div class="warningBlock">

  Note that the Control Plane set up using the Config Generator does not have
  features like <a href="../../adding-a-new-user-transformation-in-rudderstack">
    Transformations
  </a> and <a href="../live-events">Live Events</a>.
</div>
