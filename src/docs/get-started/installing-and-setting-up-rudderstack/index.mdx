...
Note that the Control Plane set up using the Config Generator does not have features like <a href="../../adding-a-new-user-transformation-in-rudderstack"> Transformations</a> and <a href="../live-events">Live Events</a>.
</div>
