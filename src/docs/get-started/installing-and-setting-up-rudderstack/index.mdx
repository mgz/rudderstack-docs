...
<div class="infoBlock">
  ...
  Refer to the <a href="../rudderstack-architecture">RudderStack Architecture</a> guide for more information the RudderStack Data Plane.
</div>
...
The <a href="../live-events">Live Events</a> console can be used to temporarily stream events for debugging purposes, but only for a limited time. **RudderStack does not persist any of your data**.
