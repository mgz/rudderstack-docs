...
To know more about the difference between **Cloud mode** and **Device mode** in RudderStack, read the <a href="../../connections/rudderstack-connection-modes/">RudderStack connection modes</a> guide.
.
</div>
