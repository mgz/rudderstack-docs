...
- [**Set up**](../../how-to-guides/rudderstack-config-generator#setting-up-the-rudderstack-config-generator) the Control Plane using the RudderStack Config Generator.
