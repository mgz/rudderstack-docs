...
<div class="infoBlock">
For more information on adding sources and destinations in RudderStack, refer to the <a href="https://rudderstack.com/docs/connections/adding-source-and-destination-rudderstack/">How to Add a Source and Destination in RudderStack</a> guide.
</div>
