...
<div class="infoBlock">
To know more about the difference between <strong>Cloud mode</strong> and <strong>Device mode</strong> in RudderStack, read the <a href="https://rudderstack.com/docs/get-started/rudderstack-connection-modes/">RudderStack connection modes</a> guide.
</div>
