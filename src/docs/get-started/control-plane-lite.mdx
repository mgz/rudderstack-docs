...
The easiest way to manage these configurations is through RudderStack's [**self-hosted web app**](https://app.rudderstack.com/). It is free, requires no setup, and has some advanced features like [**Live Events**](../user-guides/how-to-guides/live-destination-event-debugger/) and [**Transformations**](../transformations/).
...
* Once you have completed these steps above successfully, <a href="../installing-and-setting-up-rudderstack/sending-test-events/">send test events</a> to verify the installation.
...
To know more about the difference between **Cloud mode** and **Device mode** in RudderStack, read the <a href="https://rudderstack.com/docs/get-started/rudderstack-connection-modes/">RudderStack connection modes</a> guide.
</div>
...
* [**Set up**](https://rudderstack.com/docs/user-guides/how-to-guides/rudderstack-control-plane-lite#setting-up-the-rudderstack-config-generator) the Control Plane using the Control Plane Lite utility. 
