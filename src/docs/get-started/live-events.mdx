...
<div class="infoBlock">
  ...
  This feature is applicable for cases where you have connected a <a href="https://docs.rudderstack.com/transformations/#adding-a-transformation">**transformation**</a> to a destination.
