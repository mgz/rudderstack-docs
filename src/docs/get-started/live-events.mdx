...
Make sure your destination is configured in the **Cloud mode**. Refer to the <a href="../../connections/rudderstack-connection-modes/">Connection Modes</a> guide for more information on the Cloud mode.
...
Live events are shown for all the destinations. However, the **payload of the events** is not shown for some destinations like the <a href="../../destinations/storage-platforms/">object storage platforms</a> and the <a href="../../data-warehouse-integrations/">data warehouses</a> supported by RudderStack.
