...
title: "Architecture - RudderStack"
description: >-
...
<div class="successBlock">
  <strong>
    Start building a better, warehouse-first CDP that delivers complete, unified
    data to every part of your marketing and analytics stack.{" "}
    <a href="https://app.rudderlabs.com/signup?type=freetrial">
      Sign up for RudderStack Cloud Free
    </a>{" "}
    today
  </strong>
  .
...
<!-- <img src="../../images/assets/rudderstack-architecture.png" /> <span class="imageTitle">RudderStack Architecture</span> -->

<img
  src="../../images/assets/rudderstack-architecture.png"
...
<div class="infoBlock">
The RudderStack Data Plane uses PostgreSQL as a streaming database for the event data. Refer to the <strong>Data Plane Architecture</strong> section below for more information.
...
<span class="imageTitle">RudderStack Data Plane Architecture](https://lh4.googleusercontent.com/cI7FcmudLVOedkLXA2AwV0tWVI3fZtA66v3Mt8WYGEZnhC8_D-pW53twoh-BbfEBHGw-dvg5tCllbE0xwvGj1b1uPN3KpZU2PAWi0IAS36XzrrzYTm2jcSmjegti_Z57Ca9hZRn4)
...
<!-- <img src="../../images/assets/screen-shot-2021-06-07-at-1.25.57-pm.png" /><span class="imageTitle">RudderStack Backend Workflow</span> -->

<img
  src="../../images/assets/screen-shot-2021-06-07-at-1.25.57-pm.png"
...
<div class="infoBlock">
Refer to the <a href="../../user-guides/administrators-guide/config-parameters">Configuration Parameters</a> guide for more information on these configuration options.
