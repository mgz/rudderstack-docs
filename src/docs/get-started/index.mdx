...
<div class="successBlock">
  <strong>
    ...
    data to every part of your marketing and analytics stack. Sign up for{" "}
...
<div class="infoBlock">
  Do you have any questions about RudderStack? Join our{" "}
  <a href="https://resources.rudderstack.com/join-rudderstack-slack">Slack</a>{" "}
  channel and start a conversation today.
</div>
...
<img src="../../images/assets/1 (23).png" alt="Connections Dashboard" />
...
<!--<span class="imageTitle">RudderStack Sources](../../docsassets/screen-shot-2021-06-01-at-1.53.46-pm.png" />-->

<img
  src="../../images/assets/screen-shot-2021-06-01-at-1.53.46-pm.png"
...
<!--<img src="../../images/assets/screen-shot-2021-06-01-at-2.02.10-pm.png" /><span class="imageTitle">Destination Configuration Button</span>-->

<img
  src="../../images/assets/screen-shot-2021-06-01-at-2.02.10-pm.png"
...
<div class="successBlock">
  ...
  specified destinations. Read our{" "}
...
<a class="pageRef" href="../data-governance/">
  <div class="pageRefInner">
    <span class="pageRefArrow">
      <svg
        preserveAspectRatio="xMidYMid meet"
