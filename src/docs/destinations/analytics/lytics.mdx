...
<div class="successBlock">
  <strong>
    ...
    (https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/lytics).
  </strong>
</div>
...
<div class="infoBlock">
For more information on the <code class="inline-code">page</code> method, refer to our guide on <a href="../../rudderstack-api">RudderStack API Specification</a>.
...
<div class="infoBlock">
For more information on the <code class="inline-code">track</code> method, refer to our guide on <a href="../../rudderstack-api">RudderStack API Specification</a>.
...
<div class="infoBlock">
For more information on the <code class="inline-code">identify</code> method, refer to our guide on <a href="../../rudderstack-api">RudderStack API Specification</a>.
