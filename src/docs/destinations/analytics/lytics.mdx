...
For more information on the <code class="inline-code">page</code> method, refer to our guide on <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/page">RudderStack API Specification</a>.
...
To know more about how the <code class="inline-code">screen</code> call works, refer to our guide on <a href="https://rudderstack.com/docs/rudderstack-api/http-api-specification#9-screen">RudderStack API Specification</a>.
...
For more information on the <code class="inline-code">track</code> method, refer to our guide on <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/track">RudderStack API Specification</a>.
...
For more information on the <code class="inline-code">identify</code> method, refer to our guide on <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/identify">RudderStack API Specification</a>.
