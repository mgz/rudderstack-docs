...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/mp">
      GitHub repo
    </a>
    .
  </strong>
...
<div class="infoBlock">
Choose <strong>EU</strong> in <strong>Data Residency</strong> settings to send your event data to the Mixpanel EU server.
