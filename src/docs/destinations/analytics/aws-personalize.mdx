...
<div class="successBlock">
  ...
  **Find the open-source transformer code for this destination in our <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/personalize">GitHub repo</a>.**
</div>
...
<div class="successBlock">
  ...
  Keep this Tracking ID handy as it is used later to configure AWS Personalize
  as a destination.
</div>
...
<img src="../https://user-images.githubusercontent.com/59817155/129888869-c221b05e-bb80-4394-90a6-f3d84d31f76e.png" /><span class="imageTitle">Destination Settings for AWS Personalize</span>
...
The value of the <code class="inline-code">event</code> field in the payload will be sent as <code class="inline-code">EVENT_TYPE</code>, as it is a mandatory field in aws personalize schema structure. Therefore you can only send <code class="inline-code">track</code> events.
