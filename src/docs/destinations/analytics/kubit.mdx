...
<img src="../../../images/assets/image (104).png" />

<div class="infoBlock">

Follow our <a href="../../connections/adding-source-and-destination-rudderstack">guide</a> to add a source and a warehouse destination in RudderStack.
...
For more information on the <code class="inline-code">identify</code> call, refer to the <a href="../../rudderstack-api/http-api-specification">HTTP API Specification</a> guide.
...
For more information on the <code class="inline-code">track</code> call, refer to the <a href="../../rudderstack-api/http-api-specification">HTTP API Specification</a> guide.
...
If you come across any issues while using the Kubit integration, please feel free to [contact us](mailto:%20docs@rudderstack.com) or start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel. We will be happy to help you.
