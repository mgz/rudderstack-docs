...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/ga">
      GitHub repo
    </a>
    .
  </strong>
...
<img src="../../../images/assets/screenshot-2020-09-14-at-5.58.13-pm.png" />

<img src="../../../images/assets/screenshot-2020-09-14-at-5.59.00-pm.png" />

<img src="../../../images/assets/screenshot-2020-09-14-at-6.00.03-pm.png" />

<img src="../../../images/assets/screenshot-2020-09-14-at-5.56.58-pm.png" />
...
For a server-side screen call, the application name is passed from RudderStack's <code class="inline-code">context.app.name</code> as <strong><code class="inline-code">an</code></strong>, otherwise the event will be rejected by GA.

If <strong>Include the Querystring in Page Views</strong> option is turned on under Advanced options of RudderStack destination settings (please refer to the settings in the Getting Started section above), then the whole URL with query string will be sent as <strong><code class="inline-code">dp</code></strong> (Document Path). Otherwise, the query string will be removed from the URL.
...
<img src="../../../images/assets/image (59).png" /><span class="imageTitle">Custom Dimensions and Metrics Settings in RudderStack</span>

<img src="../../../images/assets/image (36).png" /><span class="imageTitle">Custom Dimensions Settings in Google Analytics</span>
...
Enhanced E-Commerce must be enabled in Google Analytics, and should follow RudderStack's [E-Commerce Tracking API](https://rudderstack.com/docs/rudderstack-api-spec/rudderstack-ecommerce-events-specification).
...
<img src="../../../images/assets/image (21).png" />
...
For more information, please check our guide on the <a href="../../rudderstack-api/rudderstack-ecommerce-events-specification">RudderStack E-Commerce Events Specification</a>.
=======
For more information, please check our guide on the <a href="../../../rudderstack-api/rudderstack-ecommerce-events-specification">RudderStack E-Commerce Events Specification</a>.
>>>>>>> origin/docs_migrate_gp
...
<img src="../../../images/assets/image (18) (1) (1) (1) (1) (1) (1) (1).png" />
...
<img src="../../../images/assets/image (67).png" /><span class="imageTitle">Content Group Mapping in RudderStack</span>

<img src="../../../images/assets/image (26).png" /><span class="imageTitle">Content Grouping Settings in Google Analytics</span>
...
<img src="../../../images/assets/image (44).png" />
...
Please refer to the [Getting Started](https://rudderstack.com/docs/destinations-guides/google-analytics-ga#getting-started) section above in this document to know how to specify these fields on the RudderStack platform.
...
<img src="../../../images/assets/image (49).png" /><span class="imageTitle">Changing the website URL from HTTP to HTTPS</span>
...
<img src="../../../images/assets/faq2.png" /><span class="imageTitle">Real-time event data report</span>
...
<img src="../../../images/assets/faq1.png" /><span class="imageTitle">Changing the website URL from HTTP to HTTPS</span>
