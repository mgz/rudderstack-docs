...
For more information, please check our guide on the <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-ecommerce-events-specification">RudderStack E-Commerce Events Specification</a>.
