...
- Integrate the RudderStack `core` SDK with your project. To know more, please refer to our [Getting Started with Unity SDK](https://rudderstack.com/docs/rudderstack-sdk-integration-guides/getting-started-with-unity-sdk) guide.
...
<li>Integrate the RudderStack <code class="inline-code">core</code> SDK with your project. To know more, please refer to our <a href="../../stream-sources/rudderstack-sdk-integration-guides/getting-started-with-unity-sdk">Getting Started with Unity SDK</a> guide.</li>
...
<li>Add the RudderStack react native SDK to your app - refer <a href="../../stream-sources/rudderstack-sdk-integration-guides/rudderstack-react-native-sdk">Getting Started with the ReactNative SDK</a>.</li>
