...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-sdk-js/tree/adobe-analytics-dest-prod-staging/integrations/AdobeAnalytics">
      GitHub repo
    </a>.
  </strong>
</div>
...
<div class="infoBlock">
Refer to the <a href="../adobe-analytics">Dashboard Settings</a> guide for more information on these settings.
