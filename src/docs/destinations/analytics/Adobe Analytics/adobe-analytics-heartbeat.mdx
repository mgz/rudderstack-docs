...
<div class="infoBlock">
The <a href="../../../destinations/analytics/adobe-analytics/">RudderStack dashboard settings</a> also has a toggle for SSL which, if enabled, will send the Heartbeat Tracking URL in the HTTPS mode.
