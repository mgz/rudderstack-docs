...
<div class="infoBlock">
  ...
  <ul>
    ...
    <li>
      Go to the **Settings** on the left sidebar and click on
      **Subscription Settings.**
    </li>
    <li>
      You will see an option called **Apps** and under that hover
      on the square box and click on **view app details**.
    </li>
    <li>
      Here you will find your **API Key** in
      **App Details** section.
    </li>
  </ul>
</div>
