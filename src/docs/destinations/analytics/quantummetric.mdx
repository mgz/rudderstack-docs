...
Follow our [**Adding a Source and Destination**](https://rudderstack.com/docs/getting-started/adding-source-and-destination-rudderstack) guide for more information.
</div>
...
<img src="../../../images/assets/quantum-metric.png" alt="Quantum Metric Connection Settings" />
### Connection Settings
...
As this is a web device mode-only integration, the **Use native SDK to send events** option cannot be disabled. For more information on the web device mode, refer to the [**RudderStack connection modes**](https://rudderstack.com/docs/get-started/rudderstack-connection-modes) guide.
</div>
