...
<div class="successBlock">
  <strong>Find the open-source JavaScript SDK code for this destination in our</strong>
  <a href="https://github.com/rudderlabs/rudder-sdk-js/tree/adobe-analytics-dest-prod-staging/integrations/AdobeAnalytics">GitHub
  repo</a>.</strong>
</div>
...
<div class="infoBlock">
Refer to the <a href="./setting-up-adobe-analytics-in-rudderstack">Dashboard Settings</a> guide for more information on these settings.
...
<div class="infoBlock">
For more info on the RudderStack E-Commerce Spec, follow the <a href="../../../rudderstack-api/api-specification/rudderstack-ecommerce-events-specification">E-Commerce Tracking API</a> guide.
