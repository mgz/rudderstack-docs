...
<div class="successBlock">
  ...
  Mobile <a href="../../../connections/rudderstack-connection-modes#device-mode"> device mode </a> refers to using the Android or iOS SDK to send your events directly to Adobe Analytics.
</div>
...
For mobile device mode, RudderStack currently does not support the <a href="../../../destinations/analytics/adobe-analytics/adobe-analytics-heartbeat#initialize-heartbeat">Initialize Heartbeat</a> and <a href="../../../destinations/analytics/adobe-analytics/adobe-analytics-heartbeat#heartbeat-playhead-update">Heartbeat Playhead Update</a> video events.
</div>
