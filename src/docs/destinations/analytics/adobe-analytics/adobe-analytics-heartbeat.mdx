...
title: "Adobe Analytics Heartbeat Events"
description: >-
...
The <a href="./setting-up-adobe-analytics-in-rudderstack">RudderStack dashboard settings</a> also has a toggle for SSL which, if enabled, will send the Heartbeat Tracking URL in the HTTPS mode.
</div>
...
The properties mapped in the <strong>Standard Video Metadata</strong> section below will also be set.
</div>
...
For more information on any of the sections covered in this documentation, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
