...
If you enter the value for the <strong>Environment</strong> field as a forward slash (`/`), new line character, space (```), or the string``None\`, Sentry will silently discard the environment configuration information without sending any error.
</div>
