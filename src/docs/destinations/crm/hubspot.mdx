...
<div class="successBlock">
  ...
  **
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/hs">
      GitHub repo
    </a>
    .
  **
...
<img src="../../../images/assets/hubspot.png" /><span class="imageTitle">Connection Settings for HubSpot in RudderStack</span>
...
To send the data to HubSpot, an initial `page` call is required. For more information on the `page` call, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) documentation.
...
<Tabs>
  <TabList>
    ...
    <TabPanels>
      ...
      <TabPanel>
        <ul>
        <li>To send the data to HubSpot, an initial <code class="inline-code">page</code> call is required. For more information on the <code class="inline-code">page</code> call, please refer to our <a href="../../rudderstack-api/rudderstack-spec">RudderStack API Specification</a> documentation.
...
A `track` call is used to record any action the user performs. For more information on the `track` call, refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
