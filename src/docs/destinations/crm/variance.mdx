...
<div class="infoBlock">
Follow the guide on <div class="infoBlock">
...
</div> for more details on adding a source in RudderStack.
...
<div class="infoBlock">
For more information on the <code>identify</code> call, refer to the <a href="../../rudderstack-api/http-api-specification">RudderStack HTTP API Specification</a> guide.
