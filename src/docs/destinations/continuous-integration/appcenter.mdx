...
<img src="../../../images/assets/appcenter.png" /><span class="imageTitle">Connection settings for App Center destination</span>
...
If you come across any issues while configuring App Center with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
