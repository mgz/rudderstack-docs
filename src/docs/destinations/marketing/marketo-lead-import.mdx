...
<strong>Find the open-source transformer code for this destination in our <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/marketo_bulk_upload">GitHub repo</a></strong>.
</div>
...
The most common source can be a <a href="../../warehouse-actions/">Warehouse Actions</a> source, as RudderStack only accepts <code class="inline-code">identify</code> events for this destination.
</div>
...
For more information on the <code class="inline-code">identify</code> call, refer to the <a href="../../rudderstack-api/api-specification/rudderstack-spec/identify/">RudderStack Events Specification</a> guide.
</div>
