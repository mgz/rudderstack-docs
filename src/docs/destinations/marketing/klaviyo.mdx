...
<div class="infoBlock">
Note that <strong><code class="inline-code">page</code> calls are only supported in the RudderStack device mode</strong> integration. To know more about the difference between Cloud mode and Device mode in RudderStack, read the <a href="../../get-started/rudderstack-connection-modes">RudderStack connection modes</a> guide.
...
<div class="infoBlock">
<strong>Adding or subscribing users to a specific list is only available in cloud-mode</strong> integration. To know more about the difference between Cloud mode and Device mode in RudderStack, read the <a href="../../get-started/rudderstack-connection-modes">RudderStack connection modes</a> guide.
