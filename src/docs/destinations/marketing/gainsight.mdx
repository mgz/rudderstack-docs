...
<strong>This integration is developed for the Gainsight CS NXT Edition.</strong>
...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/dest-gainsight">
      GitHub repo
    </a>
    .
  </strong>
...
See our <a href="../../connections">Connections</a> guide to learn more about sources and destinations in RudderStack.
...
Follow our guide on <a href="../connections/adding-source-and-destination-rudderstack">How to Add a Source and Destination in RudderStack</a> to add a source in RudderStack.

</div>

- Assign a name to this destination, and click on **Next**. You should then see the following screen:

<img src="../../../images/assets/gainsightcs-settings.png" /><span class="imageTitle">Connection screen for Gainsight</span>
...
<div class="successBlock">
  ...
  Refer to the
  <a href="../../destinations/marketing/gainsight#track">Track</a>
...
<img src="../../../images/assets/gainsightcs-custom-field-person.png" /><span class="imageTitle">gainsightcs-custom-field-person</span>

Then, you can add the RudderStack trait name for the Gainsight custom field mapping in the RudderStack dashboard as shown:

<img src="../../../images/assets/gainsightcs-person-map.png" /><span class="imageTitle">gainsightcs-field-map-person</span>
...
<img src="../../../images/assets/gainsightcs-custom-field-company.png" /><span class="imageTitle">gainsightcs-custom-field-company</span>

Then, you can add the RudderStack trait name for the Gainsight custom field mapping in the RudderStack dashboard:

<img src="../../../images/assets/gainsightcs-company-map.png" /><span class="imageTitle">gainsightcs-field-map-company</span>
...
<img src="../../../images/assets/gainsightcs-event-main-settings.png" /><span class="imageTitle">gainsight-event-main-settings</span>
...
<img src="../../../images/assets/gainsightcs-event-create.png" /><span class="imageTitle">gainsightcs-event-map-sample</span>

Then, provide this event name and the version mapping in the RudderStack dashboard as shown:

<img src="../../../images/assets/gainsightcs-event-map-sample.png" /><span class="imageTitle">gainsightcs-event-map-sample</span>
