...
Note that <strong><code class="inline-code">screen</code> calls are only supported in the RudderStack cloud mode</strong> integration. To know more about the difference between Cloud mode and Device mode in RudderStack, read the <a href="../../get-started/rudderstack-connection-modes">RudderStack connection modes</a> guide.
