...
<img src="../../../../images/assets/3 (27).png" /><span class="imageTitle">Connection Settings for Drip</span>
...
<div class="infoBlock">
The <strong>API token</strong> is required when using the Cloud mode to send your data.
...
<div class="infoBlock">
If the <strong>Campaign ID</strong> is provided, RudderStack will try to subscribe the users by default.
...
If you come across any issues while configuring Drip with RudderStack, feel free to [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
