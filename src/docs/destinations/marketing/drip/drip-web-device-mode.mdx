...
For more information on sending events via the Device mode, refer to the <a href="../../../connections/rudderstack-connection-modes/">RudderStack connection modes</a> guide.
...
<div class="successBlock">
  ...
  <strong>
    Find the open-source JavaScript SDK code for this destination in our
    <a href="https://github.com/rudderlabs/rudder-sdk-js/tree/production/integrations/Drip">
      GitHub repo
    </a>.
  </strong>
</div>
...
For more information on the <code class="inline-code">identify</code> call, check out the <a href="../../../rudderstack-api/rudderstack-spec/identify/">RudderStack API spec</a>.
...
For more information on the <code class="inline-code">track</code> call, check out the <a href="../../../rudderstack-api/rudderstack-spec/track/">RudderStack API spec</a>.
