...
For more information on sending events via the Cloud mode, refer to the <a href="../../../connections/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/drip">
      GitHub repo
    </a>
    .
  </strong>
...
<div class="infoBlock">
  ...
  <ul>
    ...
    <li>
      If <code class="inline-code">customFields</code> is present <strong>and</strong> there are other fields apart from the
...
If the <code class="inline-code">dripId</code> is provided in the call, then new users will not be created even if the <strong>User Creation Mode</strong> option is enabled in the RudderStack dashboard.
...
<strong>Note that the <code class="inline-code">track</code> call will still not be aborted in such a scenario.</strong>

</div>

## Contact Us

For any issues or questions on any of the sections covered in this guide, feel free to [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
