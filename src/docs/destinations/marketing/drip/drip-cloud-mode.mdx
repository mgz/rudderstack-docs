...
<div class="infoBlock">
  ...
  <ul>
    <li>
      If `customFields` is not present, RudderStack extracts all the fields
      apart from the ones mentioned in the table above and constructs a
      `customFields` object.
    </li>
    <li>
      If `customFields` is present **and** there are other fields apart from the
      ones mentioned in the table, RudderStack ignores them.
    </li>
    <li>The `address` field should be an object.</li>
  </ul>
</div>
