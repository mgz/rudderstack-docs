...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/moengage">GitHub repo</a>
    .
  </strong>
</div>
...
<img src="../../../images/assets/screenshot-2020-11-11-at-11.11.28-am.png" />
  ...
  <TabList>
    ...
    <TabPanels>
      <TabPanel>
        Follow these steps to add MoEngage to your iOS project:
<ul>
<li>Go your <code class="inline-code">Podfile</code> and add the <code class="inline-code">Rudder-Moengage</code> extension
<span>
...
<li>and add the following under the dependencies section
<span>
...
<li>Open your <code class="inline-code">build.gradle</code> (Module: Project) file and add the following in <code class="inline-code">buildscript</code> dependencies
<span>
...
<li>Also, Initialize the MoEngage SDK in the Application class's onCreate() method as following:
<span>
...
For information on the <code class="inline-code">identify</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
For information on the `track` call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
For more information, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
...
The reset method resets the previously identified user and the related information. For more information, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
...
<strong>RESET</strong> api is applicable only for <strong>Device</strong> Mode Connections
...
<strong>Please make sure you add the keys both in the Test and Live environment.</strong>
...
<li>After clicking <strong>SAVE</strong>, please proceed to download <code class="inline-code">serviceworker.js</code> file. Under <a href="http://app.moengage.com/v3/#/settings/4/0">Web Push Settings</a>.</li>
...
The RudderStack transformer maps the _<strong>current_time</strong> to <strong>timestamp or originalTimestamp</strong>_  
value from the event payload sent to Rudder server. This value should be passed in <strong>UTC.</strong>

</div>

<div class="infoBlock">

The _<strong>user_timezone_offset</strong>_ is mapped to _<strong>timezone</strong>_ field present under the _<strong>context</strong>_ object of the event payload. This value should be passed as <strong>tz</strong> string.  
...
The RudderStack transformer maps the _<strong>created_time</strong>_ from the _<strong>createdAt</strong>_ spec'd traits in our payload. The value should be in the <strong>ISO 8601</strong> format.  
...
If you come across any issues while configuring or using MoEngage with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
