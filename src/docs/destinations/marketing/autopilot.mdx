...
=======
Please follow our [Adding a Source and Destination](https://rudderstack.com/docs/get-started/adding-source-and-destination-rudderstack) guide to add a source and destination in RudderStack.
...
<img src="../../../images/assets/autopilot.png" /><span class="imageTitle">Autopilot Settings</span>
...
For more information on the `identify` method, please refer to our guide on [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec).
...
For more information on the `track` method, please refer to our guide on [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec).
...
You can retrieve the API key from the settings page of the [Autopilot](https://dashboard.branch.io/#/settings) dashboard. For more information, please check the [Getting Started](https://rudderstack.com/docs/destinations/autopilot#getting-started) section above.

## Contact Us

If you come across any issues while configuring Autopilot with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
