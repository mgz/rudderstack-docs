...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/firehose">
      GitHub repo
    </a>
    .
  </strong>
...
<img src="../../../images/assets/image (88).png" /><span class="imageTitle">Add Firehose as destination</span>
...
<ul>
<li>If the event name is **`page`** it will send all the calls with `type` page.</li>
<li>If event name is **`product added`** , it will send all the track events with the **`event`** product added.</li>
</ul>
  </div>
...
<img src="../../../images/assets/screenshot-2020-07-14-at-10.37.02-pm.png" />
