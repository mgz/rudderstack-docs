...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/eventbridge">
      GitHub repo
    </a>
    .
  </strong>
...
<img src="../../../images/assets/image (70).png" /><span class="imageTitle">EventBridge Destination Settings on the RudderStack Dashboard</span>
- **AWS Credentials**
...
<div class="successBlock">
  Please note that if the AWS credentials are{" "}
  <strong>already configured</strong> on your machine where the RudderStack
  server is set up, you will <strong>not</strong> need the security credentials.
</div>
...
<img src="../../../images/assets/source.png" /><span class="imageTitle">Live Events in Source Details Page</span>

You can also check for any delivery failures in the **Live Events** tab of your destination.

<img src="../../../images/assets/dest.png" /><span class="imageTitle">Live Events in the Destination Details Page</span>
