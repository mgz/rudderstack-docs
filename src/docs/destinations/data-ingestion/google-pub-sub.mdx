...
<div class="infoBlock">
For more information on the `page` method, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For more information on the `identify` method, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For more information on the `track` method, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
