...
<div class="successBlock">
  ...
  **Find the open-source transformer code for this destination in our <a href="">GitHub repo</a>(https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/azure_blob).**
</div>
