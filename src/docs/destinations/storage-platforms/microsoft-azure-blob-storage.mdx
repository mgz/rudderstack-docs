...
<div class="successBlock">
  ...
  <strong>
    Find the open-source transformer code for this destination in our <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/azure_blob">GitHub repo</a>.
  </strong>
</div>
...
<img src="../../../images/assets/screenshot-2020-01-06-at-10.04.20-am.png" />
<span class="imageTitle">Azure Blob Storage settings</span>
...
If you come across any issues while configuring or using Azure Blob Storage with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
