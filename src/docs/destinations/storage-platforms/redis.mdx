...
<div class="successBlock">
  ...
  **Find the open-source transformer code for this destination in our <a href="">GitHub repo</a>(https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/redis).**
</div>
...
<img src="../../../images/assets/screenshot-2020-11-02-at-1.51.36-pm.png" />
...
Here is an example of an **`identify`** event with traits from [RudderStack JavaScript SDK](https://rudderstack.com/docs/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk) and how it is stored in Redis.
...
<img src="../../../images/assets/image (37).png" />
