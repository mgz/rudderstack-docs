...
<div class="successBlock">
  ...
  **Find the open-source transformer code for this destination in our <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/kustomer">GitHub repo</a>.**
</div>
...
<img src="../../../images/assets/kustomer-v3-config.png" /><span class="imageTitle">Configuration Settings for Kustomer</span>
...
If you come across any issues while configuring Kustomer with RudderStack, please feel free to [**contact us**](mailto:docs@rudderstack.com). You can also start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
