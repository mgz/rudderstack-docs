...
where the traits key and value are the key-value pairs in the traits object of [Identify](https://rudderstack.com/docs/get-started/rudderstack-api-spec#identifypayload) payload. The `name` field in the template is determined from either of the following:
