...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/slack">GitHub repo</a>
    .
  </strong>
</div>
...
<img src="../../../images/assets/slack-settings.png" /><span class="imageTitle">Add Slack as destination</span>
...
where the traits key and value are the key-value pairs in the traits object of [Identify](https://rudderstack.com/docs/getting-started/rudderstack-api-spec#identifypayload) payload. The `name` field in the template is determined from either of the following:
