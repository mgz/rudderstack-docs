...
<strong>Please note that this documentation is written for Intercom v1.4.</strong>
...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/intercom">
      GitHub repo
    </a>
    .
  </strong>
...
<img src="../../../images/assets/intercom.png" /><span class="imageTitle">Connection screen for Intercom</span>
...
<!--{% tabs %}
{% tab title="Android" %}
If this is the first time you are integrating our RudderStack Android SDK to your project, please refer to our [RudderStack Android SDK](https://rudderstack.com/docs/rudderstack-sdk-integration-guides/rudderstack-android-sdk) for more information.
...
{% tab title="iOS" %}
If this is the first time you are integrating our RudderStack iOS SDK to your project, please refer to our [RudderStack iOS SDK](https://rudderstack.com/docs/rudderstack-sdk-integration-guides/rudderstack-ios-sdk) for more information.
...
<Tabs>
  <TabList>
    ...
    <TabPanels>
      <TabPanel>
        If this is the first time you are integrating our RudderStack Android SDK to your project, please refer to our <a href="../../stream-sources/rudderstack-sdk-integration-guides/rudderstack-android-sdk">RudderStack Android SDK</a> for more information.
...
```
      ...
      <TabPanel>
        If this is the first time you are integrating our RudderStack iOS SDK to your project, please refer to our <a href="../../stream-sources/rudderstack-sdk-integration-guides/rudderstack-ios-sdk">RudderStack iOS SDK</a> for more information.
...
The `identify` call captures the details about a visiting user. For more information, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
...
The <strong>Last Seen</strong> feature of the <code class="inline-code">identify</code> call has not been implemented yet. Please stay tuned!
...
The `track` call captures information related to the actions performed by the user, along with all the other properties associated with that action or event. For more information, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
...
The `page` call contains information such as the URL or the web page visited by the user. For more information, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
