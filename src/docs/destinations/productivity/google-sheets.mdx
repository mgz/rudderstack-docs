...
<div class="successBlock">
  ...
  <strong>
    ...
    (https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/googlesheets).
  </strong>
</div>
...
Please follow our [Adding a Source and Destination](https://rudderstack.com/docs/getting-started/adding-source-and-destination-rudderstack) guide to add a source and destination in RudderStack.

</div>

- Assign a name to the destination and click on **Next**. You should then see the following screen:

<img src="../../../images/assets/google-sheets-config.png" />
...
<img src="../../../images/assets/image (85).png" />
...
<strong>NOTE</strong>: For mapping `attributes` from `traits` or `properties`,
...
<strong>NOTE</strong>: We advise you to map with absolute path as it resolves
...
For more information on the <code class="inline-code">page</code> method, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
For more information on the <code class="inline-code">identify</code> method, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
For more information on the <code class="inline-code">track</code> method, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<img src="../../../images/assets/Google-Sheet-ID.png" />
<span class="imageTitle">Google Sheet ID (underlined in yellow)</span>

## Contact Us

If you come across any issues while configuring or using Google Sheets with RudderStack, please feel free to [contact us](mailto:%20contact@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
