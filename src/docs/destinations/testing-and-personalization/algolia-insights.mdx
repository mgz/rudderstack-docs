...
<img src="../../../../images/assets/Algolia.png"/><span class="imageTitle">Algolia Connection Settings</span>
...
If you come across any issues while configuring or using Algolia Insights with RudderStack, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
