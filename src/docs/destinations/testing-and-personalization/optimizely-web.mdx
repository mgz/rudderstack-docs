...
<img src="../../../../images/assets/image (50).png" />
<span class="imageTitle">Connection Settings for RudderStack Web</span>
...
If you come across any issues while configuring Optimizely Web with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
