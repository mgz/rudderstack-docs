...
<img src="../../../images/assets/image (73).png" />

<img src="../../../images/assets/image (34).png" /><span class="imageTitle">TVSquared Connection Settings in the RudderStack Dashboard</span>
...
For more information on the `page` call, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
...
For more information on how the `track` call works, please refer to our [RudderStack API Specification](https://rudderstack.com/docs/rudderstack-api-spec) guide.
