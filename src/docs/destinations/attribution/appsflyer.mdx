...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/af">GitHub repo</a>
    .
  </strong>
</div>
...
<img src="../../../images/assets/screen-shot-2021-06-08-at-4.01.45-pm.png" />
...
<div class="infoBlock">
This works only if your source has a <a href="../../connections/rudderstack-connection-modes">device mode connection</a> with AppsFlyer i.e the AppsFlyer native SDK is loaded through RudderStack.
