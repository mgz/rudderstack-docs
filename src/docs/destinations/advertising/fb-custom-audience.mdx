...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/fb_custom_audience">
      GitHub repo
    </a>
    .
  </strong>
...
<strong>The Facebook Custom Audience destination supports only <code class="inline-code">track</code> calls.</strong>
...
For adding the session information to any user addition/deletion operation, the Facebook Marketing API expects the <code class="inline-code">session_id</code>, <code class="inline-code">batch_seq</code>, <code class="inline-code">last_batch_flag</code> fields to be present. <strong>However, note that the data addition and deletion operations are possible without explicitly specifying the session information.</strong>
