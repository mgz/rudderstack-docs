...
<div class="infoBlock">
You can use our SDK to send <strong>Page Load Conversions</strong> as well as <strong>Click Conversions</strong>. However, you can send this data only through our JavaScript SDK.
...
<img src="../../../images/assets/image (40) (1) (1).png" /><span class="imageTitle">Connection Settings for Google Ads in RudderStack</span>
