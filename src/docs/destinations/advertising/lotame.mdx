...
<li>The above callback triggers a call to RudderStack SDK's <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec#track-payload"><code class="inline-code">track</code> </a>API which dumps the <code class="inline-code">track</code> call payload to a configured S3 destination in your RudderStack dashboard, each time the syncing of the DSP Pixels happens.
</li>
</ul>
      </TabPanel>
      <TabPanel>
