...
<div class="successBlock">
  **Find the open-source transformer code for this destination in our**
  [**GitHub
  repo**](https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/fb)**.**
</div>
...
<div class="successBlock">
  For more information on this option, refer to the [**Limited Data
  Use**](https://docs.rudderstack.com/destinations/advertising/facebook-app-events#limited-data-use)
  section below.
</div>
