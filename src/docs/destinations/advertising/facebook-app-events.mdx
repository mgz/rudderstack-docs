...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/fb">
      GitHub repo
    </a>
    .
  </strong>
...
<div class="infoBlock">
Please follow our guide on <a href="../../connections/adding-source-and-destination-rudderstack">How to Add a Source and Destination in RudderStack</a> for more information.

</div>

- Assign a name to the destination and click on **Next**. You should then see the following screen:

<img src="../../../images/assets/image (118).png" /><span class="imageTitle">Connection Settings for Facebook App Events</span>
...
<div class="successBlock">
  For more information on this option, refer to the{" "}
  <a href="../../destinations/advertising/facebook-app-events#limited-data-use">
    Limited Data Use
  </a>{" "}
  section below.
</div>
...
<li>Open your <code class="inline-code">/app/res/values/strings.xml</code> file and add the following lines. <strong>Remember to replace <code class="inline-code">[APP_ID]</code> with your actual app ID</strong>.
...
<div class="successBlock">
  ...
  <a href="https://developers.facebook.com/docs/marketing-apis/data-processing-options">here</a>.
</div>
