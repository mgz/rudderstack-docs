...
<div class="successBlock">
  ...
  For more information on this option, refer to the <a href="../../destinations/advertising/facebook-app-events#limited-data-use">Limited Data Use</a> section below.
</div>
