...
<div class="successBlock">
  <strong>
    Find the open-source code for this destination in our{" "}
    <a href="https://github.com/rudderlabs/rudder-sdk-js/tree/production/integrations">
      GitHub repo
    </a>
    .
  </strong>
...
<div class="warningBlock">
This integration is a Device mode-only destination for the web (JavaScript) source. For more information on what a Device mode is, refer to the <a href="../../connections/rudderstack-connection-modes">RudderStack Connection Modes</a> guide.
...
<div class="infoBlock">
Follow our <a href="../../connections/adding-source-and-destination-rudderstack">How to Add a Source and Destination in RudderStack</a> for more details.

</div>

- Assign a name to your destination and click on **Next**. You should now see the following **Connection Settings** page.

<span class="imageTitle">Configuration Settings](https://user-images.githubusercontent.com/59817155/123381912-f36d8980-d5ae-11eb-9f4c-cb75fb42ba47.png" />
...
<span class="imageTitle">Campaign Manager ad Account](https://user-images.githubusercontent.com/59817155/123381910-f23c5c80-d5ae-11eb-843c-5b1a0e4dedd2.png" />
...
<span class="imageTitle">Account Assets](https://user-images.githubusercontent.com/59817155/123381898-f0729900-d5ae-11eb-9cfa-f5063eeebb81.png" />

- If you are using the LinkedIn Insight Tag for the first time, you will see the **Install my Insight Tag** option.

<span class="imageTitle">Insight Tag](https://user-images.githubusercontent.com/59817155/123381916-f4062000-d5ae-11eb-945a-960e2dce869e.png" />

<div class="infoBlock">
If you have already set up your Insight Tag before, you will see the <strong>Manage Insight Tag</strong> option. Click on it and choose <strong>See Tag</strong>.

</div>

- Next, click on **I will use a tag manager**. You should now be able to see your **Partner ID**.

<span class="imageTitle">Partner ID](https://user-images.githubusercontent.com/59817155/123381921-f49eb680-d5ae-11eb-9135-48b3e6f7aac7.png" />
...
<span class="imageTitle">Domains](https://user-images.githubusercontent.com/59817155/123381914-f36d8980-d5ae-11eb-91a1-31f90e7e3557.png" />
