...
To know more about the difference between Cloud mode and Device mode in RudderStack, refer to the [**RudderStack connection modes**](https://rudderstack.com/docs/get-started/rudderstack-connection-modes/) guide.
</div>
...
Follow our guide on [**How to Add a Source and Destination in RudderStack**](https://rudderstack.com/docs/how-to-guides/adding-source-and-destination-rudderstack/) for more information.
</div>
...
<img src="../../../images/assets/SnapPixel-1.png" alt="Next" />
...
<img src="../../../images/assets/SnapPixel-2.png" alt="Setup Pixel" />
...
For more information on the `identify` call, check out the [**RudderStack API spec**](https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/identify/).
</div>
...
For more information on the `page` call, check out the [**RudderStack API spec**](https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/page/).
</div>
...
For more information on the `track` call, check out the [**RudderStack API spec**](https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/track/).
</div>
...
<img src="../../../images/assets/SnapPixel-2.png" alt="Pixel Code" />
