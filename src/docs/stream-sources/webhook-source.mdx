...
<div class="infoBlock">
Follow our guide on <a href="../../connections/adding-source-and-destination-rudderstack/">How to Add a Source and Destination in RudderStack</a> for more details.
</div>
