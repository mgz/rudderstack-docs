...
<img src="../../../assets/workspace-token (4) (3) (4) (4) (4) (4) (2) (1) (4).png" />
...
[Specifying Selective Destinations in the `load` Method](https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/#42-specifying-selective-destinations-in-the-load-method)
</li>
<li>

[Common Destination Names for sending events through the `load` method](https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/#41-common-destination-names)
</li>
</ul>
</div>
...
<img src="../../../assets/javascript-1.png" alt="Page call as seen in the network tab" /><span class="imageTitle">page call as seen in the Network tab</span>

<img src="../../../assets/javascript-2.png" alt="Track call as seen in the network tab" /><span class="imageTitle">track call as seen in the Network tab</span>
