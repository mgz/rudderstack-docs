...
<div class="infoBlock">
  ...
  <ul>
    <li>
      {" "}
      <a href="../rudderstack-javascript-sdk#4-1-specifying-selective-destinations-in-the-load-method">
    ...
    <li>
      {" "}
      <a href="../rudderstack-javascript-sdk#4-2-common-destination-names">
