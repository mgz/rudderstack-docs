...
<div class="infoBlock">
<strong>NOTE</strong>: You need to replace `&lt;YOUR_WRITE_KEY&gt;` with the write key in the RudderStack Control Plane and `&lt;DATA_PLANE_URL&gt;` with the URL of the RudderStack Server.
