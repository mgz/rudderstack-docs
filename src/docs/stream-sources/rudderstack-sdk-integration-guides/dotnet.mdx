...
Our library depends on <a href="http://json.codeplex.com/">Newton.JSON</a> library for JSON processing.
...
For a detailed explanation of the <code class="inline-code">identify</code> call, please refer to our <a href="../../../rudderstack-api/api-specification/rudderstack-spec/identify/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">track</code> call, please refer to our <a href="../../../rudderstack-api/api-specification/rudderstack-spec/track/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">page</code> call, please refer to our <a href="../../../rudderstack-api/api-specification/rudderstack-spec/page/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">screen</code> call, please refer to our <a href="../../../rudderstack-api/api-specification/rudderstack-spec/screen/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">group</code> call, please refer to our <a href="../../../rudderstack-api/api-specification/rudderstack-spec/group/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">alias</code> call, please refer to our <a href="../../../rudderstack-api/api-specification/rudderstack-spec/alias/">RudderStack API Specification</a> guide.
