...
<div class="infoBlock">
If <code class="inline-code">anonymousId</code> is explicitly provided by the user using the <strong><code class="inline-code">setAnonymousId</code></strong> method, the user-specified <code class="inline-code">anonymousId</code> overrides the SDK-generated one.

</div>

<div class="successBlock">
  For more information on how RudderStack handles overriding{" "}
  <code class="inline-code">anonymousId</code>, please refer to our
  <a href="../rudderstack-sdk-integration-guides/rudderstack-javascript-sdk#3-2-2-overriding-anonymousid-in-the-options-parameter">
    docs
  </a>.
</div>
...
<div class="successBlock">
  For more information on how RudderStack handles{" "}
  <code class="inline-code">anonymousId</code> in the iOS SDK, please refer to
  our
  <a href="../rudderstack-sdk-integration-guides/rudderstack-android-sdk#anonymous-id">
    docs
  </a>.
</div>
...
<div class="successBlock">
  ...
  <code class="inline-code">anonymousId</code> in the iOS SDK, please refer to
  our
  <a href="../rudderstack-sdk-integration-guides/rudderstack-ios-sdk#anonymous-id">
    docs
  </a>.
</div>
...
<strong>NOTE:</strong> The retry of failed events is not supported by all SDKs. Please see table below for support.
