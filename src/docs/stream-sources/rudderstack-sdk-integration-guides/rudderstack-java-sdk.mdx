...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">track</a> call, please refer to our <a href="../../rudderstack-api/rudderstack-spec/track">RudderStack API Specification</a> guide.
