...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">identify</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">track</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">page</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">screen</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">group</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
For a detailed explanation of the <code class="inline-code">alias</code> call, please refer to our <a href="../../rudderstack-api">RudderStack API Specification</a> guide.
...
<div class="infoBlock">
<strong>NOTE:</strong> this will only return errors that may occur with the HTTP request to the Gateway. Any errors that occur downstream will not be returned via this callback.
