...
<div class="successBlock">
  Check the [**Unity SDK codebase on
  GitHub**](https://github.com/rudderlabs/rudder-sdk-unity) \*\*\*\*to get a
  more hands-on understanding of how it works.
</div>
...
<ul>
<li> If you're using the **open-source** version of RudderStack, you are required to set up your own data plane by [**installing and setting up RudderStack**](https://docs.rudderstack.com/installing-and-setting-up-rudderstack) in your preferred dev environment.</li>
<li> If you're using the **enterprise** version of RudderStack, contact us for the data plane URL with the email ID used to sign up for RudderStack.</li>
</ul>
  </div>
