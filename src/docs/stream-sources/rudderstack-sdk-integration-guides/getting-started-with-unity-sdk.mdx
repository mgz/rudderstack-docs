...
<div class="successBlock">
  Check the{" "}
  <a href="https://github.com/rudderlabs/rudder-sdk-unity">
    Unity SDK codebase on GitHub
  </a>{" "}
  to get a more hands-on understanding of how it works.
</div>
...
<ul>
<li> If you're using the <strong>open-source</strong> version of RudderStack, you are required to set up your own data plane by <a href="../../get-started/installing-and-setting-up-rudderstack">installing and setting up RudderStack</a> in your preferred dev environment.</li>
...
<img src="../../../images/assets/unity1 (1) (2) (2).png" />
...
<img src="../../../images/assets/screenshot-2020-02-25-at-2.52.44-pm.png" />

- Click on `Import` in the import popup as shown:

<img src="../../../images/assets/screenshot-2020-02-25-at-2.54.29-pm.png" />
