...
<ul>
<li> If you're using the **open-source** version of RudderStack, you are required to set up your own data plane by <a href="../../../get-started/installing-and-setting-up-rudderstack/">installing and setting up RudderStack</a> in your preferred dev environment.</li>
