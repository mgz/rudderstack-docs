...
You shouldn't pass the <code class="inline-code">controlPlaneUrl</code> parameter during SDK initialization if you are using the dashboard from <a href="https://app.rudderstack.com">https://app.rudderstack.com</a>. This parameter is supported only if you are using our open-source <a href="../../../user-guides/how-to-guides/rudderstack-config-generator">RudderStack Config Generator</a>.
