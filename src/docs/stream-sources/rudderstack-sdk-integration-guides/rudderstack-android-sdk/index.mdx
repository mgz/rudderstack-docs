...
<div class="infoBlock">
  ...
  <ul>
    <li>
      ...
      are required to set up your own data plane by <a href="../../../get-started/installing-and-setting-up-rudderstack">installing and setting up RudderStack</a>
...
<strong>As Bintray has a sunset from 1st may, we're moving our SDK to Maven Central". All the versions, 1.0.10 onwards are available in Maven Central only.</strong>
