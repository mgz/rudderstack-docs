...
For a detailed explanation of the <code class="inline-code">identify</code> call, refer to our <a href="../../../rudderstack-api/rudderstack-spec/identify/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">track</code> call, please refer to our <a href="../../../rudderstack-api/rudderstack-spec/track/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">page</code> call, please refer to our <a href="../../../rudderstack-api/rudderstack-spec/page/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">group</code> call, refer to our <a href="../../../rudderstack-api/rudderstack-spec/group/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">alias</code> call, refer to our <a href="../../../rudderstack-api/rudderstack-spec/alias/">RudderStack API Specification</a> guide.
