...
Please follow our <a href="../../get-started/adding-source-and-destination-rudderstack">Adding a Source and Destination</a> tutorial guide to learn how to add a source in RudderStack.
