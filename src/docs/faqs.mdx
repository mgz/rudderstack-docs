...
If you come across any issue that is not listed in this guide, feel free to start a conversation on our <a href="https://rudderstack.com/join-rudderstack-slack-community">Slack</a> channel.
</div>
...
Data Plane URL
  ...
  <ul>
    <li>
      If you're using the <strong>open-source</strong> version of RudderStack, you are
      required to set up your own data plane by <a href="../get-started/installing-and-setting-up-rudderstack/">installing and setting up
      RudderStack</a> in your
      preferred environment.
    </li>
    <li>
      If you're using the <strong>enterprise</strong> version of RudderStack, please contact
      us for the data plane URL with the email ID used to sign up for
      RudderStack.
    </li>
  </ul>
</div>
...
Yes, you can use the [**RudderStack Config Generator**](../get-started/config-generator/) to self-host the control plane and configure your sources and destinations. Refer to the Config Generator section below for more information/FAQs.
...
<div class="infoBlock">
  ...
  Please note that these are conservative numbers. A single RudderStack node can
  handle **5x**+ event load at the peak; just that those events
  will get cached locally and then drained as per the regular throughput.
</div>
...
The self-hosted control plane (UI) does not support features like <strong>Transformations</strong> and <strong>Live Events Debugger</strong>, which are included for free in the <a href="https://app.rudderstack.com">RudderStack-hosted control plane</a>.
...
- Firstly, make sure you have set up the [**required user permissions**](https://rudderstack.com/docs/data-warehouse-integrations/postgresql#setting-postgresql-user-permissions) for PostgreSQL.
...
<img src="/../images/assets/mssqlconnection (1).png" />
...
You can refer to the [**RudderStack Warehouse Schema**](../data-warehouse-integrations/warehouse-schemas) documentation for details on how RudderStack generates the schema in the warehouse.
