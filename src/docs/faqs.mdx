...
<div class="infoBlock">
  ...
  <ul>
    <li>
      If you're using the **open-source** version of RudderStack, you are
    ...
    <li>
      If you're using the **enterprise** version of RudderStack, please contact
...
The self-hosted control plane (UI) does not support features like **Transformations** and **Live Events Debugger**, which are included for free in the <a href="https://app.rudderstack.com">RudderStack-hosted control plane</a>.
