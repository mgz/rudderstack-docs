...
Refer to the [**RudderStack Architecture**](get-started/rudderstack-architecture/) guide for more information the RudderStack Data Plane.
</div>
...
Yes, you can use the [**RudderStack** ](get-started/control-plane-lite/)[**Control Plane Lite**](https://github.com/rudderlabs/config-generator) to self-host the control plane and configure your sources and destinations. Refer to the **Control Plane Lite** section below for more information/FAQs.
...
You should use the `track` method in the SDK instead. For JavaScript SDK's `track` method parameters specific to eCommerce, you can refer our Google Analytics [**Enhanced eCommerce**](https://rudderstack.com/docs/destinations/google-analytics-ga#enhanced-e-commerce) guide.
