...
<div class="infoBlock">
If you come across any issue that is not listed in this guide, feel free to start a conversation on our <a href="https://resources.rudderstack.com/join-rudderstack-slack">Slack</a> channel.
...
<div class="infoBlock">
  ...
  <ul>
    <li>
      ...
      RudderStack**](get-started/installing-and-setting-up-rudderstack/) in your
...
<div class="infoBlock">
  ...
  handle <strong>5x</strong>+ event load at the peak; just that those events
