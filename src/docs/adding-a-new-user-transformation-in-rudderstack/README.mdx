...
{% hint style="success" %}
Transformations can be used across your [**Event
Stream**](../stream-sources/), [**Warehouse Actions**](../warehouse-actions/),
and [**Cloud Extract**](../cloud-extract-sources/) pipelines.
{% endhint %}
...
[**Transformations**](https://github.com/rudderlabs/sample-user-transformers)
...
{% hint style="success" %}
To see how this feature is used in more detail, check out the [**Clearbit
enrichment
example**](https://github.com/rudderlabs/sample-user-transformers/blob/sampleTransformationV1/EnrichWithClearbit.js)
