...
<div class="successBlock">
  ...
  transformations](https://docs.rudderstack.com/adding-a-new-user-transformation-in-rudderstack)
...
<div class="hostPath">
  <span class="pathName">https://api.rudderstack.com<strong>/transformations</strong></span>
</div>
...
<div class="successBlock">
  ...
  We will be using these two terms <strong>Published</strong> and <strong>Revisions</strong> for transformations and libraries throughout our
  docs.
</div>
...
<span class="apiSummary">Get all the library <strong>revisions</strong> for an ID.</span>
          ...
          <div class="parameterBlock">
            ...
            <div class="parameterBody">
              ...
              <div class="parameterRow">
                ...
                <div class="parameterBodyRight">
                  <span class="parameterDescription">
                  You can pass it either as <strong>ASC</strong> to get an ascending order or <strong>DESC</strong> for descending. By default it returns the ascending order on <strong>createdAt</strong>.
                  </span>
                </div>
              </div>
            </div>
