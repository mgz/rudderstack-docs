...
<div class="successBlock">
  Transformations can be used across your <a href="../stream-sources/">Event Stream</a>, <a href="../warehouse-actions/">Warehouse Actions</a> and <a href="../cloud-extract-sources/">Cloud Extract</a> pipelines.
</div>
...
<div class="infoBlock">
  For details on how to add a transformation in RudderStack, check the <a href="https://rudderstack.com/docs/adding-a-new-user-transformation-in-rudderstack#adding-a-transformation">Adding a New Transformation</a> section below.
</div>
