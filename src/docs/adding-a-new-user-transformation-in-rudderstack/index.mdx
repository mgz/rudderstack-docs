...
<div class="successBlock">
  Transformations can be used across your{" "}
  <a href="../stream-sources/">Event Stream</a>,{" "}
  <a href="../warehouse-actions/">Warehouse Actions</a> and{" "}
  <a href="../cloud-extract-sources/">Cloud Extract</a> pipelines.
</div>
...
<div class="infoBlock">
  For details on how to add a transformation in RudderStack, check the{" "}
  <a href="https://docs.rudderstack.com/adding-a-new-user-transformation-in-rudderstack#adding-a-transformation">
...
<div class="successBlock">
  ...
  <a href="https://github.com/rudderlabs/sample-user-transformers">
    Transformations
  </a>{" "}
  GitHub repository for some useful templates that you can use to create your
  own user transformations.
</div>

<div class="warningBlock">
<strong>Transformations only work for the Cloud mode destinations.</strong>

To know more about the Cloud mode in RudderStack, check out the <a href="../get-started/rudderstack-connection-modes">RudderStack Connection Modes</a> guide.
...
<img src="../../images/assets/image (90).png" alt="Adding a Transformation" />
...
<img src="../../images/assets/image (92).png" alt="Create New Transformation" />
<span class="imageTitle"></span>
...
<img
  src="../../images/assets/image (100).png"
...
<img src="../../images/assets/image (99).png" alt="transformEvent function" />
<span class="imageTitle"></span>
...
You can copy-paste the entire code of any of the functions present in this repository into the <strong>Transformation</strong> window.

</div>

<div class="warningBlock">
  Remember to delete the pre-populated{" "}
  <code class="inline-code">transformEvent</code> function in such cases, before
  pasting your code.
</div>
...
<img src="../../images/assets/image (97).png" alt="Run Test" />
<span class="imageTitle"></span>
...
<strong>Disclaimer for using <code class="inline-code">transformBatch</code></strong>

Make sure you pass on the <code class="inline-code">messageID</code> from the input event onto the output event. If the <code class="inline-code">messageID</code> is passed on, the order of delivery of events is preserved. <strong>Without it, this order may not be maintained</strong>.
...
<img src="../../images/assets/image (89).png" alt="Create new library" />
...
<img
  src="../../images/assets/image (91).png"
...
<img
  src="../../images/assets/image (95).png"
  alt="Add more functions under a single library"
/>

<div class="warningBlock">
<strong>RudderStack does not support the deletion of libraries as of now.</strong>
...
<img
  src="../../images/assets/image (101).png"
...
<img
  src="../../images/assets/image (86).png"
...
<img src="../../images/assets/image (98).png" alt="Source ID" />
<span class="imageTitle">Source ID</span>

<!--<img src="../../images/assets/image (120) (1) (1).png" />-->

<img src="../../images/assets/image (120) (1) (1).png" alt="Source ID" />
...
<div class="successBlock">
  To see how this feature is used in more detail, check out the{" "}
  <a href="https://github.com/rudderlabs/sample-user-transformers/blob/sampleTransformationV1/EnrichWithClearbit.js">
    Clearbit enrichment example
  </a>{" "}
  which uses the <code class="inline-code">fetch</code> function.
</div>
...
<img
  src="../../images/assets/image (103) (2) (2) (2) (2) (2) (1) (2) (2) (2) (2) (1).png"
