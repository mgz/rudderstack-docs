---
slug: "/docs/rudderstack-api/rudderstack-spec/group"
title: "Group - RudderStack"
...
A sample payload for the `group` event after removing the common fields mentioned in the [**Common Fields**](common-fields.md) section is as shown:
...
The `group` call has the following fields in addition to the [**Common Fields**](common-fields.md):
