...
<div class="successBlock">
  ...
  <ul>
    <li>[**MoEngage**](../../destinations/marketing/moengage.md)</li>
    <li>[**Kissmetrics**](../../destinations/analytics/kissmetrics.md)</li>
    <li>
      [**Amplitude**](../../destinations/analytics/amplitude.md) (only supported
      by the [**JavaScript
      SDK**](../../stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/)
      via [**Cloud
      Mode**](https://docs.rudderstack.com/connections/rudderstack-connection-modes#cloud-mode))
    </li>
  </ul>
</div>
...
<div class="successBlock">
  The RudderStack SDK automatically passes the user's `anonymousId` as
  `previousId` in the payload, as seen above.
</div>
