---
# slug: "/docs/rudderstack-api/rudderstack-spec/screen"
title: "Screen"
...
The corresponding event that generates the above payload via the [**iOS SDK**](../../stream-sources/rudderstack-sdk-integration-guides/rudderstack-ios-sdk/) is as shown:
