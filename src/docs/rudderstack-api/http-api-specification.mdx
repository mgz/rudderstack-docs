...
To send HTTP requests, you should have a RudderStack server configured with your workspace token. Please refer to [this section](https://rudderstack.com/docs/get-started/installing-and-setting-up-rudderstack) for setting up and running RudderStack. The RudderStack's HTTP server should be accessible from your HTTP client.
