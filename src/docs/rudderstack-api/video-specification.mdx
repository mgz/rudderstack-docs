---
# slug: "/docs/rudderstack-api/video-specification"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">
        <p>
          <code>content_asset_id</code>
        </p>
        <p>
          <code>content_asset_ids</code>
        </p>
      </td>
      <td style="text-align:left">
        <p>String</p>
      ...
      <td style="text-align:left">
        ...
        <p></p>
        <p>
          For <code>Video Playback Started</code> events, an array
        </p>
    ...
    <tr>
      <td style="text-align:left">
        <p>
          <code>content_pod_id</code>
        </p>
        <p>
          <code>content_pod_ids</code>
        </p>
      </td>
      <td style="text-align:left">
        <p>String</p>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          event. The values can be &apos;<code>pre-roll</code>&apos;, &apos;
          <code>mid-roll</code>&apos;, and
        </p>
        <p>
          &apos;<code>post-roll</code>&apos;.
        </p>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p></p>
        <p>
          Only applicable on the <code>Video Playback Seek Started</code>
          <br />
          events. On Video Playback Seek Completed events,
        </p>
        <p>
          the <code>seek_position</code> should be equal to
          <code>position</code>.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p></p>
        <p>
          Set to <code>null</code> in case of a livestream playback.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">Integer</td>
      <td style="text-align:left">
        Bit rate of the video playback, denoted in <code>kbps</code>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          playback. Example: <code>youtube</code>, <code>vimeo</code>, etc.
        </p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        Set to <code>true</code> if the playback is in fullscreen
        <br />
        mode.
      </td>
    </tr>
    <tr>
      <td style="text-align:left">
        <code>ad_enabled</code>
      </td>
      <td style="text-align:left">Boolean</td>
      <td style="text-align:left">
        <p>
          Set to <code>false</code> if the user has any ad blockers.
        </p>
        <p>
          <br />
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>
          For the <code>Video Playback Interrupted</code> events,
          <br />
    ...
    <tr>
      ...
      <td style="text-align:left">Boolean</td>
      <td style="text-align:left">
        Set to <code>true</code> in case the playback is a live stream,
        <br />
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">
        <code>full_episode</code>
      </td>
      <td style="text-align:left">Boolean</td>
      <td style="text-align:left">
        Set to <code>true</code> the video content asset is a full episode.
      </td>
    </tr>
    <tr>
      <td style="text-align:left">
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p></p>
        <p>
          For livestream playback, this should be set to <code>null</code>.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">Integer</td>
      <td style="text-align:left">
        Denotes the current bit rate in <code>kbps</code>.
      </td>
    </tr>
    <tr>
      <td style="text-align:left">
      ...
      <td style="text-align:left">Float</td>
      <td style="text-align:left">
        Denotes the frame rate in <code>fps</code>.
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          &apos;<code>pre-roll</code>&apos;, &apos;<code>mid-roll</code>&apos;,
          or &apos;<code>post-roll</code>&apos;.
        </p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          ...
          <br />
          <br />
          Values can be either &apos;<code>dynamic</code>&apos; or &apos;<code>
            linear
          </code>&apos;.
        </p>
      </td>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>
          For the <code>Video Ad Playing</code> event, this property
        </p>
        <p>can be used to indicate when a specific ad quartile</p>
        <p>is reached.</p>
        <p></p>
        <p>If you are using a client-side library to track your</p>
        <p>video events, this property is optional as RudderStack</p>
...
For more information on the RudderStack video spec, feel free to [**contact us**](mailto:%20docs@rudderstack.com). You can also start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
