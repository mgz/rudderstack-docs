...
A sample payload for the `identify` event after removing the common fields mentioned in the [**Common Fields**](common-fields/) section is as shown:
...
The `identify` call has the following fields in addition to the [**Common Fields**](common-fields/):
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          already passed the <code class="inline-code">firstName</code> and
        </p>
        <p>
          <code class="inline-code">lastName</code>, RudderStack will
        </p>
