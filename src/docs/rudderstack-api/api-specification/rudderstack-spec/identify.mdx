...
<div class="successBlock">
  ...
  <a href="../../../stream-sources/rudderstack-sdk-integration-guides">SDKs</a>
  automatically use anonymous IDs to track unknown users on your website or
  mobile apps, so you don't have to worry about including an{" "}
  <code class="inline-code">anonymousId</code>
  explicitly.
</div>
