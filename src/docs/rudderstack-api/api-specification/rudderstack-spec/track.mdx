...
A sample payload for the `track` event after removing the common fields mentioned in the [**Common Fields**](common-fields/) section is as shown:
...
Apart from the [**Common Fields**](common-fields/), the `track` call accepts the following fields:
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          result in a <code class="inline-code">revenue</code> of <code class="inline-code">20.00</code>
        </p>
      </td>
    </tr>
    <tr>
