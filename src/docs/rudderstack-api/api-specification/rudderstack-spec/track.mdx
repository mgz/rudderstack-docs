...
<div class="infoBlock">
Each user action is called an event. Every event has a name associated with it, e.g. <strong>Product Reviewed</strong>. This event might also have some properties associated with it, like <code class="inline-code">review_id</code> and <code class="inline-code">rating</code>.

</div>

<div class="successBlock">
  For E-Commerce specific events, refer to our{" "}
  <a href="../rudderstack-ecommerce-events-specification">
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>
          result in a <code>revenue</code> of <code>20.00</code>
        </p>
      </td>
    </tr>
    <tr>
...
<div class="successBlock">
  Different destinations recognize some of the above traits differently. For
  example, Mixpanel has a <code class="inline-code">track_charges</code> method
  for tracking revenue. With RudderStack, you don't have to worry about these
  inconsistencies. In this case, you can pass the{" "}
  <code class="inline-code">revenue</code> property and RudderStack will handle
