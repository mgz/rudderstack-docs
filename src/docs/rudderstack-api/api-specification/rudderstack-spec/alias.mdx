  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Optional</p>
        <p>
          (if <code class="inline-code">anonymousId</code> is already set)</p>
      </td>
      <td style="text-align:left">
        <p>The user&apos;s identifier in your database.</p>
        <p>
          Either of <code class="inline-code">userId</code> or <code class="inline-code">anonymousId</code> should be
          present.
        </p>
      </td>
    </tr>
