...
title: "Warehouse Actions Sources - RudderStack"
description: >-
...
<div class="successBlock">
  ...
  <a href="../connections">Connections guide</a>.
</div>
...
<div class="successBlock">
  <strong>
    With this feature, you can configure your data warehouse as a source on the{" "}
    <a href="https://app.rudderlabs.com/signup?type=freetrial">
      RudderStack dashboard
    </a>
    , select the right data and then sync this data to all the supported
    destinations.
  </strong>
</div>
...
<img src="../../images/assets/2 (1) (1).png" />
...
<img src="../../images/assets/screen-shot-2020-12-08-at-9.37.06-pm.png" />

<div class="warningBlock">
RudderStack currently supports <strong>Google BigQuery</strong>, <strong>PostgreSQL</strong>, <strong>ClickHouse</strong>, <strong>Amazon Redshift</strong>, and <strong>Snowflake</strong> as sources. The connection settings will vary according to each warehouse.
...
<img src="../../images/assets/4 (7).png" />

<div class="warningBlock">
  Please note that your source table must include at least one of the following
  columns for it to be considered a valid source:
  <ul>
    <li>
      <strong>
    ...
    <li>
      <strong>
        <code class="inline-code">user_id</code>
      </strong>
    </li>
    <li>
      <strong>
...
<img src="../../images/assets/6 (6).png" />

<img src="../../images/assets/7 (2) (1).png" />
