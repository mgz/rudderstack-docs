...
This feature is currently available only for the [**HubSpot**](../../destinations/crm/hubspot), [**Salesforce**](../../destinations/crm/salesforce), [**Mailchimp**](../../destinations/marketing/mailchimp), and [**Braze**](../../destinations/marketing/braze) destinations.
</div>
...
Follow our guide on [**Adding a Source and Destination in RudderStack**](../../connections/adding-source-and-destination-rudderstack) for more information.
</div>
...
This feature is currently available only for the [**Braze**](../../destinations/marketing/braze) destination.
</div>
