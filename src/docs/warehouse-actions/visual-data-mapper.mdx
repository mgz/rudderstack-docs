...
title: "Visual Data Mapper - RudderStack"
description: >-
...
<div class="infoBlock">
  This feature is currently available only for the{" "}
  <a href="../destinations/crm/hubspot">HubSpot</a>,{" "}
  <a href="../destinations/crm/salesforce">Salesforce</a>,{" "}
  <a href="../destinations/marketing/mailchimp">Mailchimp</a>, and{" "}
  <a href="../destinations//marketing/braze">Braze</a>
  destinations.
</div>
...
Clicking on <strong>Map with JSON</strong> will cause the visual data mapping feature to be disabled - you can then configure the data via JSON.
...
<div class="successBlock">
  ...
  click on <strong>Reload schemas and tables</strong> to get all the latest
  schemas and tables.
</div>
...
<div class="successBlock">
  ...
  on <strong>Reload objects</strong> to get all the latest objects.
</div>
