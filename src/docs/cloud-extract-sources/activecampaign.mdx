...
<!--<img src="../../images/assets/2 (28).png" />-->

<img src="../../images/assets/2 (28).png" alt="Directory" />

- Assign a name to your source, and click on **Next**.

<!--<img src="../../images/assets/3 (25).png" />-->

<img src="../../images/assets/3 (25).png" alt="Assign a name" />

### Specifying Connection Credentials

- Next, click on the **Create Credentials from Scratch** option, as shown:

<!-- <img src="../../images/assets/4 (24).png" />-->

<img
  src="../../images/assets/4 (24).png"
  alt="Create credentials from scratch"
/>

<div class="successBlock">
  If you've already configured ActiveCampaign as a source before, you can choose
  the account visible under the <strong>Use existing credentials</strong> tab.
</div>

- Then, enter the required connection credentials to give RudderStack access to your ActiveCampaign account.

<!--<img src="../../images/assets/5 (23).png" />-->

<img
  src="../../images/assets/5 (23).png"
...
<!--<img src="../../images/assets/settings.png" />-->

<img src="../../images/assets/settings.png" alt="Account Name" />
...
<!--<img src="../../images/assets/settings-2.png" />-->

<img src="../../images/assets/settings-2.png" alt="URL and API Key" />
...
<!--<img src="../../images/assets/6 (21).png" />-->

<img src="../../images/assets/6 (21).png" alt="Run Frequency" />
...
<!--<img src="../../images/assets/7 (16).png" />-->

<img src="../../images/assets/7 (16).png" alt="Choose ActiveCampaign data" />
...
<!--<img src="../../images/assets/8 (8).png" />-->

<img src="../../images/assets/8 (8).png" alt="Ingesting Data" />
...
If you come across any issues while configuring ActiveCampaign as a source on the RudderStack dashboard, feel free to [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
