...
While RudderStack supports teams and individual workspaces in its <strong>Enterprise edition</strong> - Looker does not allow for individual Action Hub configurations for different members of the same organization.
...
<h4>
  ...
  <strong>The authorization token to be used is:</strong>
</h4>
...
<!-- <img src="../../images/assets/image (28).png" /> <span class="imageTitle" />RudderStack-hosted Action Hub</span>-->

<img src="../../images/assets/image (28).png" alt="Authorization" />
...
<!-- <img src="../../images/assets/screen-shot-2020-12-04-at-11.02.19-am.png" /> <span class="imageTitle">Looker Source Write Key</span> -->

<img
  src="../../images/assets/screen-shot-2020-12-04-at-11.02.19-am.png"
  alt="Rudder Write Key"
/>
...
<!-- <img src="../../images/assets/image (11).png" /><span class="imageTitle">Configuring the Write Key and the RudderStack Server URL</span> -->

<img src="../../images/assets/image (11).png" alt="Google Analytics" />
...
In <strong>some</strong> specific cases - e.g. Redis - the <code class="inline-code">user_id</code> field always needs to be present, even if the <code class="inline-code">email</code> field is present.
