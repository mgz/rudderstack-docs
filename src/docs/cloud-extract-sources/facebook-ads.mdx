...
<div class="infoBlock">
If you have already connected RudderStack to your Facebook Ads account, your credentials should appear automatically under <strong>Use existing credentials</strong>.
