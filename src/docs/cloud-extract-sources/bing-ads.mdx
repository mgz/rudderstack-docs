...
<div class="infoBlock">
  ...
  <strong>
    All the Cloud Extract sources support sending data only to a data warehouse
    destination.
  </strong>
</div>
...
<img
  src="../../images/assets/1 (15) (1) (1).png"
  alt="Log into your RudderStack Dashboard"
/>
...
<img src="../../images/assets/1 (26).png" alt="Directory" />
...
<img src="../../images/assets/2 (30).png" alt="Connect with Bing Ads" />

<div class="successBlock">

  If you've already configured Bing Ads as a source before, you can choose the
  account visible under the <strong>Use existing credentials</strong> tab.
</div>
...
<!--<img src="../../images/assets/3 (30).png" />-->

<img
  src="../../images/assets/3 (30).png"
  alt="Report Name and Report Columns"
/>
...
<!--<img src="../../images/assets/6 (24).png" />-->

<img src="../../images/assets/6 (24).png" alt="Add Destination" />

<div class="infoBlock">
  
  Select the <strong>Use Existing Destination</strong> option if you have
  already configured a data warehouse destination in RudderStack. To configure a
  data warehouse destination from scratch, select the
  <strong>Create New Destination</strong> option.
</div>
...
If you come across any issues while configuring Bing Ads as a source on the RudderStack dashboard, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
