...
If you've already configured Mailchimp as a source before, you can choose the account visible under the <strong>Use existing credentials</strong> tab.
...
<img src="../../images/assets/" alt="Google Analytics" />
