...
<div class="successBlock">
  ...
  RudderStack and Segment, the migration <strong>should not require</strong> any
...
If you come across any issues while migrating your Salesforce source to RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
