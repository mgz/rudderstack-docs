...
<div class="successBlock">
  ...
  on the <strong>Connect with Salesforce</strong> option will automatically
...
Salesforce’s API strictly enforces a limit on its usage. A high <strong>Run Frequency</strong> may exceed your Salesforce’s API. This may cause a failure when RudderStack tries to sync your data.
...
<div class="infoBlock">
<strong>Note that RudderStack will only read your data</strong>.
