...
<img src="../../images/assets/2 (4).png" />

- Assign a name to your source, and click on **Next**.

<img src="../../images/assets/3 (6).png" />

### Specifying Connection Credentials

- Next, enter your Zendesk credentials. This includes your Zendesk **Subdomain**, your **Zendesk username**, and the API **Token**.

<img src="../../images/assets/4 (2).png" />

<div class="infoBlock">

To create a Zendesk API token, log into your Zendesk dashboard, and navigate to <strong>Admin</strong> - <strong>Channels</strong> - <strong>API</strong> in the Zendesk admin interface, and click the <strong>Add New Token</strong> link.

</div>

<div class="infoBlock">

If you've already configured Zendesk as a source before, you can choose the account visible under the <strong>Use existing credentials</strong> tab.
...
If you come across any issues while configuring Zendesk as a source on the RudderStack dashboard, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel; we will be happy to talk to you!
