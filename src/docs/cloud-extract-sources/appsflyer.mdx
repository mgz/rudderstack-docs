...
<!-- <img src="../../images/assets/AF_choose_src.png" /><span class="imageTitle">Choose AppsFlyer as a source</span>-->

<img
  src="../../images/assets/AF_choose_src.png"
  alt="Choose AppsFlyer as a source"
/>
<span class="imageTitle">Choose AppsFlyer as a source</span>

- Enter the name of your source, and click on **Next**.

<!-- <img src="../../images/assets/AF_src_name.png" /><span class="imageTitle">Provide source name </span> -->

<img src="../../images/assets/AF_src_name.png" alt="Provide source name" />
<span class="imageTitle">Provide source name</span>
...
<!--<img src="../../images/assets/AF_Dashboard.png" />-->

<img src="../../images/assets/AF_Dashboard.png" alt="AF Dashboard" />
...
You can validate the endpoint using the <strong>Send Test</strong> button.
</div>

<!--<img src="../../images/assets/AF_src_sendtest.png" /><span class="imageTitle">Endpoint Configuration</span>-->

<img
  src="../../images/assets/AF_src_sendtest.png"
  alt="Endpoint Configuration"
/>
<span class="imageTitle">Endpoint Configuration</span>
...
If you come across any issues while configuring AppsFlyer as a source with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel - we will be happy to talk to you!
