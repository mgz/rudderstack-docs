...
Please check our <a href="../data-warehouse-integrations/warehouse-schemas">Warehouse Schemas</a> guide to know how events are mapped to the tables in Snowflake.
...
<div class="successBlock">
  ...
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/snowflake">
      GitHub repo
    </a>
    .
  </strong>
...
<img src="../../images/assets/screenshot-2020-03-31-at-11.56.32-am.png" /><span class="imageTitle">creating x-small warehouse screenshot</span>
...
<img src="../../images/assets/screenshot-2020-02-27-at-5.33.31-pm.png" /><span class="imageTitle">Creating a database in Snowflake</span>
...
<img src="../../images/assets/screenshot-2020-02-27-at-5.34.41-pm.png" /><span class="imageTitle">Creating a user in Snowflake</span>
...
Please follow our <a href="../connections/adding-source-and-destination-rudderstack">Adding a Source and Destination</a> guide to know how to add a source in RudderStack.
...
<img src="../../images/assets/4 (3) (2) (2) (1) (2).png" /><span class="imageTitle">Connection Settings for configuring Snowflake as a Destination</span>

<img src="../../images/assets/5 (2).png" /><span class="imageTitle">Connection Settings for configuring Snowflake as a Destination</span>
...
- Add the required credentials in the **Connection Settings** as described below:
  ...
  - **Database** - The name of the database, as created in the [Creating a Database](https://rudderstack.com/docs/destinations/snowflake#creating-a-database) section
  - **Warehouse** - The name of the warehouse, as created in the [Creating a Virtual Warehouse](https://rudderstack.com/docs/destinations/snowflake#creating-a-virtual-warehouse) section
  - **User** - This is the username, as created in [Creating a User](https://rudderstack.com/docs/destinations/snowflake#creating-a-user) section.
  - **Password** - This is the password, as created in [Creating a User](https://rudderstack.com/docs/destinations/snowflake#creating-a-user) section.
...
- The following settings are applicable if you are using an Amazon S3 bucket for object storage:
  ...
  - **AWS Secret Access Key** - This can be obtained from AWS Console. Please refer to the [Setting Up Amazon S3](https://rudderstack.com/docs/destinations-guides/amazon-s3#setting-up-amazon-s3) section for more details.
...
<strong>Configuring snowflake integration with AWS </strong>
...
<strong>Configuring snowflake integration with Azure </strong>
<ol>
<li>Create a storage account in Azure.</li>
<li>Create a container in the storage account created above by navigating to <strong>&lt;storage_account&gt;</strong> - <strong>Storage Explorer</strong> - <strong>Blob Containers</strong> - <strong>Create a Blob Container</strong>.</li>
...
<strong>Configuring Snowflake Integration with Google Cloud Platform </strong>
...
<ul>
  ...
  <li>
    ...
    <a href="../data-warehouse-integrations/snowflake#configuring-snowflake-in-rudderstack">
      above
    </a>
  </li>
  <li>
...
```
        ...
        <ul>
            <li>
              ...
              created above{" "}
              <a href="../data-warehouse-integrations/snowflake#creating-a-role-for-rudderstack">
                here
              </a>
            </li>
            <li>
...
<strong>The IPs to be whitelisted are : <code class="inline-code">3.216.35.97</code>, <code class="inline-code">34.198.90.241</code> , <code class="inline-code">54.147.40.62</code> , <code class="inline-code">23.20.96.9</code>, and <code class="inline-code">18.214.35.254</code>.</strong>
</div>
