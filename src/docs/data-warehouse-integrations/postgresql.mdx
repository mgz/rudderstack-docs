...
<div class="infoBlock">
Please check our <a href="../data-warehouse-integrations/warehouse-schemas">Warehouse Schemas</a> guide to know how events are mapped to the tables in PostgreSQL.
...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/postgres">
      GitHub repo
    </a>
    .
  </strong>
...
<img src="../../images/assets/image (69).png" /><span class="imageTitle">PostgreSQL Destination Settings on the RudderStack dashboard</span>
