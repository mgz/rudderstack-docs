...
<div class="infoBlock">
Please check our <a href="../data-warehouse-integrations/warehouse-schemas">Warehouse Schemas</a> guide to know how events are mapped to the tables in Azure Synapse.
...
<div class="successBlock">
  <strong>
    ...
    <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/azure_synapse">
      GitHub repo
    </a>
    .
  </strong>
...
<div class="successBlock">
  Please follow our{" "}
  <a href="../connections/adding-source-and-destination-rudderstack">
...
<img src="../../images/assets/azure-synapse-connection.png" />
