  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        ...
        <a href="https://rudderstack.com/docs/data-warehouse-integration-guides/warehouse-schemas#standard-rudderstack-properties">
...
<code class="inline-code">sentAt</code> &gt; <code class="inline-code">original_timestamp</code> is **always true**. However, <code class="inline-code">timestamp</code> can be more or less than the <code class="inline-code">original_timestamp</code>. Refer to the examples below for more details.
...
<div class="successBlock">
  ...
  query for unique users in the dataset. Refer to the <a href="../data-warehouse-integrations/google-bigquery#schema-partitioned-tables-and-views">BigQuery documentation</a> for more details.
</div>
