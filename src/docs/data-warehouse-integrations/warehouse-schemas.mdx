...
<div class="successBlock">
  ...
  query for unique users in the dataset. Refer to the [**BigQuery
  documentation**](https://docs.rudderstack.com/data-warehouse-integrations/google-bigquery#schema-partitioned-tables-and-views)
  \*\*\*\*for more details.
</div>
...
<div class="successBlock">
  To get at a user’s `anonymous_id`, you can query the `identifies` table by
  grouping on the `user_id` column.
</div>
