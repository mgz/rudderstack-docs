...
[**GitHub
repo**](https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/mssql)**.**
{% endhint %}
...
import into your SQL Server database. Optionally, you can also specify the
