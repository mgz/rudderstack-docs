...
<div class="infoBlock">
Please follow our <a href="../connections/adding-source-and-destination-rudderstack">Adding a Source and Destination</strong> guide to know how to add a source in RudderStack.
