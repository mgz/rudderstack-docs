...
<div class="infoBlock">
  ...
  Refer to the{" "}
  <a href="../stream-sources/rudderstack-sdk-integration-guides">
    SDK documentation
  </a>{" "}
  for more details.
</div>
...
<img src="/images/gitbook/assets/workspace-token-vs-write-key.png" /><span class="imageTitle">Workspace Token vs Source Write Key</span>
