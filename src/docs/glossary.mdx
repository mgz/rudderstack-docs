...
<ul>
<li> **RudderStack-hosted**: RudderStack hosts both Control Plane and Data Plane</li>
<li> **Hybrid**: RudderStack hosts the Control Plane and the user hosts the Data Plane</li>
<li> **Customer**: User hosts both the Control Plane and Data Plane via open-source.</li>
</ul>
  </div>
...
**Incoming events** -- **User Transformation** -- **
...
**Incoming events** -- **RudderStack Transformer** -- **
  Routed to the specified destination/s
**
