...
<div class="successBlock">
  ...
  If you come across any term that is not listed here, you can <a href="mailto:docs@rudderstack.com">contact
  us</a> or start a conversation on our <a href="https://rudderstack.com/join-rudderstack-slack-community">Slack</a> channel.
</div>
...
<div class="successBlock">
  ...
  Check out our <a href="https://rudderstack.com/blog/rudderstack-cloud-extract-makes-cloud-to-warehouse-pipelines-easy">blog</a> to read more about ETL and how RudderStack facilitates it via its <a href="../cloud-extract-sources/">Cloud Extract</a> feature.
</div>
...
<div class="successBlock">
  ...
  Check out our <a href="https://rudderstack.com/blog/reverse-etl-is-just-another-data-pipeline">blog</a> to read more about Reverse ETL and how RudderStack facilitates it via its <a href="../warehouse-actions/">Warehouse Actions</a> feature.
</div>
...
<div class="infoBlock">
  ...
  For more information on the Data Plane and Control Plane, refer to
  RudderStack's <a href="../get-started/rudderstack-architecture/">architecture</a>.
</div>
...
<ul>
<li> <strong>RudderStack-hosted</strong>: RudderStack hosts both Control Plane and Data Plane</li>
<li> <strong>Hybrid</strong>: RudderStack hosts the Control Plane and the user hosts the Data Plane</li>
<li> <strong>Customer</strong>: User hosts both the Control Plane and Data Plane via open-source.</li>
</ul>
  </div>
...
For information on the Config Generator and how to use it, refer to the <a href="../get-started/config-generator/">docs</a>.
</div>
...
<div class="infoBlock">
  ...
  For more information on the various Event Stream sources supported by
  RudderStack, check out the <a href="../stream-sources/">docs</a>.
</div>
...
For more information on the various Cloud Extract sources and how to set them up in RudderStack, check out the <a href="../cloud-extract-sources/">docs</a>.
</div>
...
For more information on the various Warehouse Actions sources and how to set them up in RudderStack, check out the <a href="../warehouse-actions/">docs</a>.
</div>
...
<strong>Incoming events</strong> -- <strong>User Transformation</strong> -- <strong>
  RudderStack Transformer
</strong> -- <strong>Routed to the specified destination's</strong>

In the absence of a user transformation, the flow is as follows:

<strong>Incoming events</strong> -- <strong>RudderStack Transformer</strong> -- <strong>
  Routed to the specified destination/s
</strong>
...
For more details on this feature and how to use it, check out our <a href="../adding-a-new-user-transformation-in-rudderstack/">Transformations</a> docs.
</div>
...
For more information on this feature, check out our <a href="../get-started/live-events/">docs</a>.
</div>
...
Refer to the <a href="../data-governance/rudderstack-data-governance-api/">RudderStack Data Governance API</a> reference for the detailed technical documentation.
</div>
...
Refer to the <a href="../rudderstack-api/user-suppression/">RudderStack User Suppression API</a> reference for more information.
</div>
...
<div class="infoBlock">
  ...
  For more information on sources and destinations in RudderStack, check our <a href="../connections/">Connections</a> guide.
</div>
...
Setting up a connection involves <a href="../connections/adding-source-and-destination-rudderstack/">adding a source and destination</a> in RudderStack.
</div>
...
For more information on these modes, check the <a href="../connections/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
</div>
...
For more information on RudderStack sources, check out our <a href="../connections/#sources">documentation</a>.
</div>
...
RudderStack currently supports over 80 destinations. These include <a href="../data-warehouse-integrations/">data warehouses</a>, <a href="../destinations/analytics/">analytics</a> platforms, <a href="../destinations/crm/">CRMs</a>, <a href="../destinations/marketing/">marketing</a> platforms, and more.

Check out the <a href="../destinations/">Destinations</a> guide for the complete list of supported destinations.
</div>
...
For more information on how to use these warehouse destinations, check out our <a href="../data-warehouse-integrations/">Data Warehouse Integration</a> guides.
</div>
...
<div class="infoBlock">
  ...
  For more information on the RudderStack API Specification, refer to our <a href="../rudderstack-api/api-specification/rudderstack-spec/">docs</a>.
</div>
...
<div class="infoBlock">
  ...
  Refer to the <a href="../stream-sources/rudderstack-sdk-integration-guides">
    SDK documentation
  </a>
  for more details.
</div>
...
Refer to the <a href="../data-warehouse-integrations/warehouse-schemas/">Warehouse Schema documentation</a> for more details.
</div>
...
<img src="/../images/assets/workspace-token-vs-write-key.png" /><span class="imageTitle">Workspace Token vs Source Write Key</span>

## Contact Us

For any questions on any of the topics covered in this guide, you can [**contact us**](mailto:docs@rudderstack.com). You can also start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel.
