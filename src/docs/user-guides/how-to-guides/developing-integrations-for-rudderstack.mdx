---
# slug: "/docs/user-guides/how-to-guides/developing-integrations-for-rudderstack"
...
RudderStack currently supports over 80 [**destinations**](https://rudderstack.com/docs/destinations/).
...
The RudderStack [**SDKs**](https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/) help the developers capture business events within their enterprise systems and route them to RudderStack. The events sent from the SDKs to RudderStack follow a canonical model and are independent of the programming language or the source platform.
...
To know more about how to develop Integrations or any queries related to them, feel free to [**contact us**](mailto:%20docs@rudderstack.com). You can also start a conversation on our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) channel. We will be happy to help you!
