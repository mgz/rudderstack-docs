...
plugins: [
  {
    ...
    options: {
      ...
      // Rudderstack docs:
      //   - https://rudderstack.com/docs/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk#31-load
      dataPlaneUrl: `https://override-rudderstack-endpoint`,
      // Add a `controlPlaneUrl` property if you are self-hosting the Control Plane
      // Rudderstack docs:
      //   - https://rudderstack.com/docs/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk#311-self-hosted-control-plane
