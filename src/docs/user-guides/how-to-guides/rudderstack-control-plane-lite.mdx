...
* **​**[**Set up**](https://rudderstack.com/docs/how-to-guides/rudderstack-control-plane-lite/#setting-up-the-control-plane) the Control Plane using the Control Plane Lite utility.
