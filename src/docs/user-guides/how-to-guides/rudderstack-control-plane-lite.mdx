...
<img src="../../../../images/assets/image (132).png" alt="rudder-docker.yml" />
...
To know more about the difference between **Cloud mode** and **Device mode** in RudderStack, read the [**RudderStack connection modes**](https://rudderstack.com/docs/get-started/rudderstack-connection-modes/) guide.
</div>
...
* **​**[**Set up**](https://rudderstack.com/docs/how-to-guides/rudderstack-control-plane-lite#setting-up-the-rudderstack-config-generator) the Control Plane using the Control Plane Lite utility.
