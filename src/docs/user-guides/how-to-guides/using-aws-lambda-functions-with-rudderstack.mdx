...
<img src="../../../images/assets/aws-lambda-1.png" alt="Install the rudderstack node sdk" />

- Archive all the contents of the lambda function development directory in a ZIP file, as shown below:

<img src="../../../images/assets/aws-lambda-2.png" alt="Archive all the contents of the lambda function" />

- Update the lambda function deployment, as shown:

<img src="../../../images/assets/aws-lambda-3.png" alt="Update the lambda function" />
