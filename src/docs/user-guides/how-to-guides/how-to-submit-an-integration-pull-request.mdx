...
=======
Repeat the steps above for each of the repositories - <strong><code class="inline-code">rudder-transformer</code></strong>, <strong><code class="inline-code">config-generator</code></strong>, and <strong><code class="inline-code">rudderstack-docs</code></strong>.
