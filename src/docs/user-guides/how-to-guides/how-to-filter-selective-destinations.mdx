...
title: "Filter Selective Destinations - RudderStack"
description: >-
...
<div class="successBlock">
  <strong>NOTE</strong>: Unless explicitly defined otherwise,{" "}
...
<div class="infoBlock">
The line <strong><code class="inline-code">All: false</code></strong> instructs RudderStack <strong>not</strong> to send the event data to any destinations <strong>by default,</strong> unless they are explicitly listed as <strong><code class="inline-code">true</code></strong> in the subsequent lines.
