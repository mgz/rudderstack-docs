...
<img src="../../../images/assets/1 (24).png" alt="Create App Integration" />

- Select **SAML 2.0** as the sign-in method, as shown:

<!--![](../../.gitbook/assets/2 (29).png)-->

<img src="../../../images/assets/2 (29).png" alt="SAML 2.0" />

- Enter **RudderStack** as the **App name**.

<!--![](../../.gitbook/assets/3 (26).png)-->

<img src="../../../images/assets/3 (26).png" alt="Rudderstack as app name" />

In the next page, enter the following settings:

<!--![](../../.gitbook/assets/4 (26).png)-->

<img src="../../../images/assets/4 (26).png" alt="Enter the settings" />
...
<img src="../../../images/assets/6 (22).png" alt="Sign on" />
...
<img src="../../../images/assets/image_-7-.png" alt="Copy the following fields" />
