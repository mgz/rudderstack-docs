---
# slug: "/docs/user-guides/administrators-guide/admin-troubleshooting-guide"
...
<div class="successBlock">
  If the control plane is accessible from your network but is down, we are
  already working to fix it. Do leave us a note.
</div>
...
<div class="successBlock">
  You can restart the server in the normal mode by updating the
  <code class="inline-code">/data/rudderstack/recovery_data.json</code> or <code class="inline-code">
    /tmp/recovery_data.json
  </code>. Set Mode to "normal"
</div>
...
- If there are tables that start with _``_`pre*drop```* but if you don't see them being removed, verify the access credentials to your object storage like S3.
...
<div class="infoBlock">
For any other issues that you might encounter, please feel free to <a href="https://rudderstack.com/contact/">contact us</a>.
...
For any other issues or bugs that you might encounter, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel, and we will be happy to help!
