---
# slug: "/docs/user-guides/administrators-guide/horizontal-scaling-1"
...
<div class="successBlock">
  The <code class="inline-code">values.yaml</code> file can be found
  <a href="https://github.com/rudderlabs/rudderstack-helm/blob/master/values.yaml">
    here
  </a>.
</div>
...
<img src="../../../images/assets/image (17).png" />
...
<img src="../../../images/assets/image (65).png" />
<span class="imageTitle">Scaling Down from 2 Nodes to 1 Node</span>

<div class="infoBlock">
To understand how RudderStack handles hardware failures and guarantees High Availability, please go through our <a href="../administrators-guide/high-availability">
...
<img src="../../../images/assets/image (27).png" />
...
<img src="../../../images/assets/image (55).png" />
<span class="imageTitle">Scaling Down in RudderStack Enterprise</span>

## Contact Us

If you want to know more about horizontal scaling in RudderStack, or if you have any queries or concerns on how to implement it effectively, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel to know more about this feature.
