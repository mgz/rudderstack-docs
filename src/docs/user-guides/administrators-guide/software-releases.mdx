...
At RudderStack, we strive to make our deployment simple. To get started, please go through our guide on [installing and setting up RudderStack](https://rudderstack.com/docs/get-started/installing-and-setting-up-rudderstack) on the platform of your choice.
...
For more information on the software releases or if you need the latest binaries, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation on our [Slack](https://rudderstack.com/join-rudderstack-slack-community) channel, and we will be happy to help you.
