...
This section refers to the number of events RudderStack has received in the selected time period. The RudderStack API allows multiple events to be [batched inside a single HTTP request](https://rudderstack.com/docs/rudderstack-api-spec/http-api-specification#12-batch).
...
This usually happens during a sudden surge in the traffic, but syncs over a period of time. If this is consistently high, <strong>consider adding an extra RudderStack node</strong>.

</div>

## Event Delivery

<img src="../../../images/assets/3.png" />
...
<img src="../../../images/assets/screenshot_2020-12-09_at_11.17.00_pm.png" />
...
<img src="../../../images/assets/screenshot_2020-12-10_at_12.49.12_pm.png" />
