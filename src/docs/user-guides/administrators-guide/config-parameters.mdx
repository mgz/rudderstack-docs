...
These configuration parameters are also applicable for the **<code class="inline-code">config.toml</code>** file, in case you have an older RudderStack deployment.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        Enables or disables the backup. This is set to <code class="inline-code">false</code> in the <a href="https://rudderstack.com/docs/user-guides/administrators-guide/high-availability#rudderstack-server-running-modes">
          Degraded
        </a> mode.
      </td>
      <td style="text-align:center">
