...
const Singleblog = ({ data, ...props }) => {
  ...
  return (
    <Layout>
      ...
      <div className="block-description pt-16 max-w-4xl m-auto px-4 md:px-3"> {/*Blog Content*/}
      ...
      <section className="bg-white pb-0"> {/*Blog Post*/}
      ...
      <section className="bg-backgroundsecondary 100% left-right-section">{/*Sign Up Section*/}
      ...
      <div className="max-w-6xl px-4 md:px-3 mx-auto flex items-center flex-wrap">{/*Subscription Component*/}
        <Subscription />
      </div>{/*Subscription Component*/}
    </Layout>
  )
}
