  ...
  return current ? (
    ...
    >
      {prev && current.title !== "Home" && (
        <Post isLeft>
          <Link to={docsBasePath + prev.link} className="previous" onClick={(e) => rudderslabTrackOnClick("postNav", null, e, true)}>
      ...
      {next && current.title !== "FAQs" && (
        <Post>
          <Link to={docsBasePath + next.link} className="next" onClick={(e) => rudderslabTrackOnClick("postNav", null, e, true)}>
