...
import SourceFaq from "../components/source-faq"
...
const SourceIntegration = ({ data }) => {
  ...
  return (
    <Layout>
        ...
        <div className="max-w-6xl px-4 md:px-3 mx-auto pt-24 pb-28 pb-0 lg:py-24">
          <div className="flex items-center flex-wrap">
            ...
            <div className="sm:w-1/2 sm:p-6 sm:pl-0 sm:pt-0 sm:mt-6 md:pr-0">
              ...
              <span class="mt-11 sm:mt-14 font-bold leading-normal text-sm relative inline-flex sm:inline-block hover:text-blueNew-custom">
                Ready to Get Started?
                </span>
              <div class="relative block sm:flex sm:mt-14 mt-16">
                <a class="btn-primary-lg sm:mr-4 md:mb-0 mb-6" href="#">Try this in RudderStack</a>
              </div>
            </div>
      ...
      <section class="bg-grayColor-BgGray md:pt-32 md:pb-24 sm:pt-16 sm:pb-12 pt-11 pb-12 relative font-custom">
      <SourceFaq />
      </section>
      <section className="100% bg-whiteColor-custom">
