  ...
  return (
    <Layout>
      <div className="font-custom">
        <section id="contact_us_banner" className="w-full conract-us-bg mb-16 md:mb-40">
          <div className="max-w-6xl px-4 md:px-3 sm:my-20 md:mt-10 md:mb-10 mx-auto relative banner-section ">
            <div className="flex flex-col items-center gap-0 md:gap-8 justify-center mx-auto sm:flex-row lg:p-0">
              <div className="z-20 flex flex-col justify-start  w-full pb-1 mr-30 mb-8 sm:mb-16 text-2xl sm:w-1/2 sm:px-0 lg:items-start lg:mb-0 ">
                <p class="my-4 text-blueNew-eastbay text-sm uppercase">
                  Contact Us
                </p>
                <h2
                  className="mb-8 md:mb-4 text-4xl md:text-6xl font-bold"
